...
## <a name="step-2-displaying-the-products-in-a-repeater"></a>Krok 2: Zobrazení v Repeateru produkty
...
[![CVytvořit prvku ObjectDataSource a nakonfigurujte ho na použití metody GetProductsAsPagedDataSource()](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image2.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image1.png)

**Obrázek 1**: Prvku ObjectDataSource vytvořit a nakonfigurovat jej pro použití `GetProductsAsPagedDataSource()` – metoda ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image3.png))


[![Set rozevírací seznamy na kartách UPDATE, INSERT a DELETE na (žádný)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image5.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image4.png)
...
[![EZobrazí se ACH produkt s názvem, dodavatele a kategorie](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image8.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image7.png)

**Obrázek 3**: Zobrazí se každý produkt s názvem, dodavatele a kategorie ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image9.png))
...
[![Tmá produkty jsou seřazeny podle názvu v abecedním pořadí reverzní](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image11.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image10.png)

**Obrázek 4**: Produkty jsou seřazeny podle názvu v abecedním pořadí reverzní ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image12.png))
...
**Obrázek 5**: Přidat `ListItem` pro každé pole řazení dat
...
[![The produkty jsou zpočátku seřazené podle názvu jejich](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image15.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image14.png)

**Obrázek 6**: Produkty jsou zpočátku seřazené podle názvu ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image16.png))


[![The produkty jsou teď seřazené podle kategorie](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image18.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image17.png)

**Obrázek 7**: Produkty jsou teď seřazené podle kategorie ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image19.png))
...
[![Replikovat deklarativní v &lt;asp: Content&gt; značek z Paging.aspx SortingWithDefaultPaging.aspx](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image21.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image20.png)
...
[![BVýchozí y, výsledky jsou seřazeny podle ProductName](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image24.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image23.png)

**Obrázek 9**: Ve výchozím nastavení, výsledky jsou seřazené podle `ProductName` ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image25.png))
...
[![The produkty jsou seřazeny podle kategorie](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image27.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image26.png)

**Obrázek 10**: Produkty jsou seřazeny podle kategorie ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image28.png))


[![TVýraz řazení je uloží, při stránkování prostřednictvím Data](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image30.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image29.png)

**Obrázek 11**: Výraz řazení se uloží, při stránkování prostřednictvím Data ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image31.png))
...
[![Configurovat ObjectDataSource použít ProductsBLL třídu s metodou GetProductsPaged](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image33.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image32.png)
...
[![LParametr zdrojů nastaven na hodnotu None eave](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image36.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image35.png)
...
[![TPrvních pět záznamů he zobrazují](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image39.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image38.png)

**Obrázek 14**: Prvních pět záznamů se zobrazí ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image40.png))
...
[![Tmá předchozí a poslední tlačítka jsou zakázány při procházení první stránky produktů](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image42.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image41.png)

**Obrázek 15**: Předchozí a poslední tlačítka jsou zakázány při procházení první stránky produktů ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image43.png))


[![Tmá druhou stránku produktů jsou zobrazeny](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image45.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image44.png)

**Obrázek 16**: Druhá stránka produktů se zobrazí ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image46.png))


[![Clicking poslední zobrazí Data poslední stránky](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image48.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image47.png)
...
[![Tmá Data poslední stránky, seřazeno podle kategorie, zobrazí se](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image51.png)](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image50.png)

**Obrázek 18**: Poslední Data stránky, seřazeno podle kategorie, zobrazí se ([kliknutím ji zobrazíte obrázek v plné velikosti](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image52.png))
