...
> 
> - **OnActionExecuting**(ActionExecutingContext filterContext): Metoda je volána těsně před akce.
...
3. Přejděte do **/ActionLog** zobrazíte počáteční stav zobrazení protokolu.
    ...
    *Protokolu sledování stavu před aktivity stránku*
4. Klikněte na některou **žánry** z nabídky a provést některé akce, třeba k procházení alba k dispozici.
5. Zkontrolujte, že současné době vaší návštěvy byly sledovány seřazené podle hodnoty pořadí filtrů: **CustomActionFilter** protokoly první.
