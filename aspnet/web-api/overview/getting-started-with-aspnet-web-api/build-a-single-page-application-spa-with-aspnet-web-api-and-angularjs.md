...
5. V **přidat existující položku** dialogové okno, přejděte na **zdroj/prostředky/modely** složky a vyberte všechny soubory. Klikněte na **Přidat**.
...
<a id="Exercise2"></a>
### <a name="exercise-2-creating-the-spa-interface"></a>Cvičení 2: Vytváří se rozhraní SPA
...
2. V **přidat existující položku** dialogové okno, přejděte na **zdroj/prostředky** a pak zvolte položku **Flip.css**. Klikněte na **Přidat**.
