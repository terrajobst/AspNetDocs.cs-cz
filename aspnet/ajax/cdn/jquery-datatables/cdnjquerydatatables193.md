...
title: 1\.9.3y jQuery DataTables | Microsoft Docs
...
ms.locfileid: "78563180"
---
# <a name="jquery-datatables-193"></a><span data-ttu-id="74208-102">jQuery DataTables 1.9.3</span><span class="sxs-lookup"><span data-stu-id="74208-102">jQuery DataTables 1.9.3</span></span>

<span data-ttu-id="74208-103">Následující soubory pro moduly plug-in jQuery DataTables jsou hostovány v CDN:</span><span class="sxs-lookup"><span data-stu-id="74208-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
