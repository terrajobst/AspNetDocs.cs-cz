...
title: 1\.9.2Y jQuery DataTables | Microsoft Docs
...
ms.locfileid: "78563173"
---
# <a name="jquery-datatables-192"></a><span data-ttu-id="4a47c-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="4a47c-102">jQuery DataTables 1.9.2</span></span>

<span data-ttu-id="4a47c-103">Následující soubory pro moduly plug-in jQuery DataTables jsou hostovány v CDN:</span><span class="sxs-lookup"><span data-stu-id="4a47c-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
