...
| **E-mail** | (žádné e-mailová adresa bude fungovat) |
| **Bezpečnostní otázku** | (cokoli, co chcete) |
| **Zabezpečovací odpověď** | (cokoli, co chcete) |

*Poznámka: Samozřejmě můžete použít jakékoli heslo, které chcete. Výchozí nastavení zabezpečení hesel vyžadují heslo, které má 7 znaků a obsahuje jeden jiný než alfanumerický znak.*
...
*Poznámka: Atribut [Authorize] se můžou umístit na konkrétní akci metody i na úrovni třídy Kontroleru.*
