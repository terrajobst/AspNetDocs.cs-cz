...
[![aktualizace jenom kontaktů](iteration-7-add-ajax-functionality-vb/_static/image1.jpg)](iteration-7-add-ajax-functionality-vb/_static/image1.png)
...
**Výpis 3-Controllers\ContactController.vb (metoda index)**
...
[![stránce pro potvrzení odstranění](iteration-7-add-ajax-functionality-vb/_static/image2.jpg)](iteration-7-add-ajax-functionality-vb/_static/image3.png)

**Obrázek 02**: Stránka pro potvrzení odstranění ([kliknutím zobrazíte obrázek v plné velikosti](iteration-7-add-ajax-functionality-vb/_static/image4.png))
