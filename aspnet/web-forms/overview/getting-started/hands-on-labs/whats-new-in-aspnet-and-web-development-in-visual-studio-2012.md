...
5. <span data-ttu-id="e3b43-159">Ujistěte se, že je povolena funkce Inteligentní odsazení.</span><span class="sxs-lookup"><span data-stu-id="e3b43-159">Make sure that the smart indentation feature is enabled.</span></span> <span data-ttu-id="e3b43-160">Vyberte **nástroje** | **možnosti** nabídky a pak vyberte **textový Editor** | **šablon stylů CSS**  |  **Formátování** stránky v levém podokně na obrazovce.</span><span class="sxs-lookup"><span data-stu-id="e3b43-160">Select the **Tools** | **Options** menu option, and then select the **Text Editor** | **CSS** | **Formatting** page in the left pane of the screen.</span></span> <span data-ttu-id="e3b43-161">Zkontrolujte, **hierarchické odsazení** možnost.</span><span class="sxs-lookup"><span data-stu-id="e3b43-161">Check the **Hierarchical indentation** option.</span></span>
    ...
    <span data-ttu-id="e3b43-163">*Povolení hierarchické odsazení*</span><span class="sxs-lookup"><span data-stu-id="e3b43-163">*Enabling hierarchical indentation*</span></span>
...
1. <span data-ttu-id="e3b43-197">V **Site.css** souboru, vyhledejte **záhlaví** šablon stylů CSS třídy definice (.header) a umístěte kurzor na slovo níže **/ \*poloměr ohraničení\* /** zástupný symbol pro přidání nové fragment kódu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-197">In the **Site.css** file, locate the **header** CSS class definition (.header) and place the cursor below the **/\*border radius\*/** placeholder to add a new snippet.</span></span> <span data-ttu-id="e3b43-198">Stisknutím klávesy **Enter** zobrazíte seznam technologie IntelliSense a typ **radius** pro filtrování seznamu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-198">Press **Enter** to display the IntelliSense list and type **radius** to filter the list.</span></span> <span data-ttu-id="e3b43-199">Vyberte **border-radius** možnost ze seznamu poklikejte na a pak stiskněte klávesu **kartu** klíče pro vložení fragmentu kódu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-199">Select the **border-radius** option from the list with a double click, and then press the **TAB** key to insert the snippet.</span></span> <span data-ttu-id="e3b43-200">Zadejte velikost protokolu radius v pixelech a stiskněte klávesu **Enter**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-200">Then, type a radius size in pixels and press **Enter**.</span></span> <span data-ttu-id="e3b43-201">Například zadejte **15px**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-201">For instance, type **15px**.</span></span>
    ...
    <span data-ttu-id="e3b43-203">![Pomocí fragmentu kódu border-radius](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image17.png "pomocí fragmentu kódu border-radius")</span><span class="sxs-lookup"><span data-stu-id="e3b43-203">![Using a border-radius snippet](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image17.png "Using a border-radius snippet")</span></span>
...
6. <span data-ttu-id="e3b43-213">Stisknutím klávesy enter zobrazte seznam technologie IntelliSense, typ **box-shadow** a stiskněte klávesu **kartu** klíč dvakrát pro vložení fragmentu kódu stínové výchozí uvnitř definice třídy.</span><span class="sxs-lookup"><span data-stu-id="e3b43-213">Press enter to display the IntelliSense list, type **box-shadow** and press the **TAB** key twice to insert the default shadow code snippet inside the class definition.</span></span> <span data-ttu-id="e3b43-214">Nastavte hodnoty stínové na **10px 10px 5px #888**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-214">Set the shadow values to **10px 10px 5px #888**.</span></span> <span data-ttu-id="e3b43-215">Potom zadejte **border-radius** a Vložit fragment kódu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-215">Then, type **border-radius** and insert the code snippet.</span></span> <span data-ttu-id="e3b43-216">Typ **15px** nastavit velikost protokolu radius a stiskněte klávesu **ENTER**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-216">Type **15px** to set radius size and press **ENTER**.</span></span>
    ...
    <span data-ttu-id="e3b43-218">*Zaoblené rohy se stínovou*</span><span class="sxs-lookup"><span data-stu-id="e3b43-218">*Rounded corners with shadow*</span></span>
...
6. <span data-ttu-id="e3b43-257">Vrátit zpět změny na cílové schéma pro ověření nástrojů vybrat typ dokumentu: XHTML5 z rozevíracího seznamu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-257">Undo the changes to the Target Schema for Validation Toolbar, picking DOCTYPE: XHTML5 from the dropdown list.</span></span>
    ...
    <span data-ttu-id="e3b43-258">![Používat typ Doctype v úpravy zdrojového kódu HTML nástrojů](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image25.png "použití Doctype v panelu nástrojů Úpravy zdrojového kódu HTML")</span><span class="sxs-lookup"><span data-stu-id="e3b43-258">![Use Doctype in HTML Source Editing toolbar](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image25.png "Use Doctype in HTML Source Editing toolbar")</span></span>
...
5. <span data-ttu-id="e3b43-291">Teď si vyzkoušejte vložíte ovládací prvek v některé části stránky.</span><span class="sxs-lookup"><span data-stu-id="e3b43-291">Now, try to insert a control in some part of the page.</span></span> <span data-ttu-id="e3b43-292">Například, pokuste se vložit **GridView** ovládacího prvku, ale místo zadání  **&lt;mřížky,** začněte psát  **&lt;GV**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-292">For example, try to insert a **GridView** control, but instead of typing **&lt;Gri,** start typing **&lt;GV**.</span></span> <span data-ttu-id="e3b43-293">Všimněte si, že v seznamu technologie IntelliSense se zobrazí **asp: GridView** ovládacího prvku.</span><span class="sxs-lookup"><span data-stu-id="e3b43-293">Notice that the IntelliSense list shows the **asp:GridView** control.</span></span>
    ...
    <span data-ttu-id="e3b43-299">*Vkládání prvek GridView s částečnou shodu a seznamy IntelliSense*</span><span class="sxs-lookup"><span data-stu-id="e3b43-299">*Inserting a GridView with IntelliSense lists and partial matching*</span></span>
...
4. <span data-ttu-id="e3b43-338">Všimněte si, že vybraný kód byl extrahován do uživatelského ovládacího prvku a byl nahrazen původní umístění vybraném kódu s instancí nového uživatelského ovládacího prvku.</span><span class="sxs-lookup"><span data-stu-id="e3b43-338">Notice that the selected code was extracted to a user control and the original location of the selected code was replaced with an instance of the new user control.</span></span>
    ...
    <span data-ttu-id="e3b43-339">![Stránka automaticky aktualizována na používání nového uživatelského ovládacího prvku](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image37.png "stránky automaticky aktualizována na používání nového uživatelského ovládacího prvku")</span><span class="sxs-lookup"><span data-stu-id="e3b43-339">![Page automatically updated to use the new user control](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image37.png "Page automatically updated to use the new user control")</span></span>
...
4. <span data-ttu-id="e3b43-390">Napište libovolný řetězec jako v poslední řádek souboru **&quot;testování&quot;** (včetně uvozovek označuje jako řetězec).</span><span class="sxs-lookup"><span data-stu-id="e3b43-390">In the last line of the file, write any string like **&quot;test&quot;** (include the quotation marks to indicate it is as string).</span></span> <span data-ttu-id="e3b43-391">Zápis období vedle řetězec, který se zobrazí seznam technologie IntelliSense a vyberte **trim** možnost.</span><span class="sxs-lookup"><span data-stu-id="e3b43-391">Write a period next to the string to display the IntelliSense list, and select the **trim** option.</span></span>
    ...
    <span data-ttu-id="e3b43-392">Ve standardním ECMAScript5 řetězcové hodnoty a proměnné nemají řetězcových metod, které jsou definované jako oříznout, velká písmena, vyhledávání a nahrazení.</span><span class="sxs-lookup"><span data-stu-id="e3b43-392">In ECMAScript5 standard, string values and variables also have string methods defined, like trim, uppercase, search and replace.</span></span>

    <span data-ttu-id="e3b43-393">![Seznam technologie IntelliSense v jazyce JavaScript](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image43.png "seznam technologie IntelliSense v jazyce JavaScript")</span><span class="sxs-lookup"><span data-stu-id="e3b43-393">![IntelliSense list in JavaScript](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image43.png "IntelliSense list in JavaScript")</span></span>

    <span data-ttu-id="e3b43-394">*Seznam technologie IntelliSense v jazyce JavaScript*</span><span class="sxs-lookup"><span data-stu-id="e3b43-394">*IntelliSense list in JavaScript*</span></span>

<a id="Ex3Task3"></a>

<a id="Task_3_-_XML_Documentation_for_JavaScript"></a>
#### <a name="task-3---xml-documentation-for-javascript"></a><span data-ttu-id="e3b43-395">Úloha 3 – dokumentace XML pro jazyk JavaScript</span><span class="sxs-lookup"><span data-stu-id="e3b43-395">Task 3 - XML Documentation for JavaScript</span></span>

<span data-ttu-id="e3b43-396">V této úloze bude prozkoumání funkcí sady Visual Studio pro dokumentaci XML v jazyce JavaScript.</span><span class="sxs-lookup"><span data-stu-id="e3b43-396">In this task, you will explore Visual Studio features for XML documentation in JavaScript.</span></span> <span data-ttu-id="e3b43-397">Zobrazí se že seznam technologie IntelliSense jazyka JavaScript nyní zobrazuje dokumentace XML jednotlivých funkcí.</span><span class="sxs-lookup"><span data-stu-id="e3b43-397">You will see the JavaScript IntelliSense list now shows the XML documentation of each function.</span></span> <span data-ttu-id="e3b43-398">Kromě toho bude zjišťovat navigační funkce v jazyce JavaScript.</span><span class="sxs-lookup"><span data-stu-id="e3b43-398">Additionally, you will discover the navigation feature in JavaScript.</span></span>

1. <span data-ttu-id="e3b43-399">Otevřít **XMLDoc.js** soubor umístěný ve **skripty a vlastní** složky projektu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-399">Open **XMLDoc.js** file located in **Scripts/custom** project folder.</span></span> <span data-ttu-id="e3b43-400">Tento soubor obsahuje dokumentaci XML na všech funkcí jazyka JavaScript.</span><span class="sxs-lookup"><span data-stu-id="e3b43-400">This file contains XML documentation on each of the JavaScript functions.</span></span>

    <span data-ttu-id="e3b43-401">![Dokumentace JavaScript XML integrované technologie IntelliSense](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image44.png "dokumentace JavaScript XML integrované technologie IntelliSense")</span><span class="sxs-lookup"><span data-stu-id="e3b43-401">![JavaScript XML documentation integrated to IntelliSense](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image44.png "JavaScript XML documentation integrated to IntelliSense")</span></span>

    <span data-ttu-id="e3b43-402">*Dokumentace JavaScript XML integrované technologie IntelliSense*</span><span class="sxs-lookup"><span data-stu-id="e3b43-402">*JavaScript XML documentation integrated to IntelliSense*</span></span>
2. <span data-ttu-id="e3b43-403">Pod **přidat** fungovat v **XMLDoc.js** soubor, vytvořte novou funkci s názvem **testování**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-403">Below **add** function in **XMLDoc.js** file, create a new function named **test**.</span></span>
3. <span data-ttu-id="e3b43-404">V **testování** fungovat, zavolejte **vynásobit** funkce, která přijímá dva parametry.</span><span class="sxs-lookup"><span data-stu-id="e3b43-404">In the **test** function, call the **multiply** function that receives two parameters.</span></span> <span data-ttu-id="e3b43-405">Všimněte si, že pole Popis se zobrazuje **vynásobit** dokumentaci k funkci.</span><span class="sxs-lookup"><span data-stu-id="e3b43-405">Notice the tooltip box is showing the **multiply** function documentation.</span></span>

    [!code-javascript[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample9.js)]

    <span data-ttu-id="e3b43-406">![Dokumentace XML pro funkce jazyka JavaScript](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image45.png "dokumentace XML pro funkce jazyka JavaScript")</span><span class="sxs-lookup"><span data-stu-id="e3b43-406">![XML documentation for JavaScript functions](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image45.png "XML documentation for JavaScript functions")</span></span>

    <span data-ttu-id="e3b43-407">*Dokumentace XML pro funkce jazyka JavaScript*</span><span class="sxs-lookup"><span data-stu-id="e3b43-407">*XML documentation for JavaScript functions*</span></span>
4. <span data-ttu-id="e3b43-408">Dokončení příkazu call funkce a typ *tečkou* o otevření seznamu technologie IntelliSense pro vrácené hodnoty.</span><span class="sxs-lookup"><span data-stu-id="e3b43-408">Complete the function call statement and type a *dot* to open the IntelliSense list on the returned value.</span></span> <span data-ttu-id="e3b43-409">Všimněte si, že se detekuje aplikace Visual Studio **vrátit** hodnotu v dokumentaci, zpracuje hodnotu jako číslo.</span><span class="sxs-lookup"><span data-stu-id="e3b43-409">Notice that Visual Studio is detecting the **return** value in the documentation, treating the value as a number.</span></span>

    <span data-ttu-id="e3b43-410">![Dokumentace XML pro typy vrácených hodnot](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image46.png "dokumentace XML pro návratové typy")</span><span class="sxs-lookup"><span data-stu-id="e3b43-410">![XML documentation for return types](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image46.png "XML documentation for return types")</span></span>

    <span data-ttu-id="e3b43-411">*Dokumentace XML pro návratové typy*</span><span class="sxs-lookup"><span data-stu-id="e3b43-411">*XML documentation for return types*</span></span>
5. <span data-ttu-id="e3b43-412">Nyní vložte volání pro přidání funkce.</span><span class="sxs-lookup"><span data-stu-id="e3b43-412">Now, insert a call to add function.</span></span> <span data-ttu-id="e3b43-413">Všimněte si, že editor JavaScriptu teď podporuje přetížení funkce.</span><span class="sxs-lookup"><span data-stu-id="e3b43-413">Notice that the JavaScript editor now supports function overloads.</span></span> <span data-ttu-id="e3b43-414">Při zápisu název funkce, budou moct vyberte některou z dostupných přetížení zadané v dokumentaci.</span><span class="sxs-lookup"><span data-stu-id="e3b43-414">When you write a function name, you will be able to select any of the available overloads specified in the documentation.</span></span>

    <span data-ttu-id="e3b43-415">![Dokumentace XML pro přetížení](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image47.png "dokumentace XML pro přetížení")</span><span class="sxs-lookup"><span data-stu-id="e3b43-415">![XML documentation for overloads](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image47.png "XML documentation for overloads")</span></span>

    <span data-ttu-id="e3b43-416">*Dokumentace XML pro přetížení*</span><span class="sxs-lookup"><span data-stu-id="e3b43-416">*XML documentation for overloads*</span></span>
6. <span data-ttu-id="e3b43-417">Otevřít **GotoDefinition.js** souboru a vyhledejte **$().html()** volání funkce.</span><span class="sxs-lookup"><span data-stu-id="e3b43-417">Open **GotoDefinition.js** file and locate the **$().html()** function call.</span></span> <span data-ttu-id="e3b43-418">Najít kurzor na **html**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-418">Locate the cursor on **html**.</span></span>
7. <span data-ttu-id="e3b43-419">Stisknutím klávesy **F12** a přejít k definici.</span><span class="sxs-lookup"><span data-stu-id="e3b43-419">Press **F12** and navigate to the definition.</span></span> <span data-ttu-id="e3b43-420">Všimněte si, že teď můžete používat a procházet kód JavaScriptu bez použití **najít** nástroj.</span><span class="sxs-lookup"><span data-stu-id="e3b43-420">Notice you can now access and browse your JavaScript code without using the **Find** tool.</span></span>
8. <span data-ttu-id="e3b43-421">Najděte kurzor na instrukci jQuery před blok signatury na konci souboru kódu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-421">Locate the cursor on the jQuery instruction prior to the signature block at the bottom of the code file.</span></span> <span data-ttu-id="e3b43-422">Stisknutím klávesy **F12**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-422">Press **F12**.</span></span> <span data-ttu-id="e3b43-423">Bude přejděte na soubor knihovny jQuery.</span><span class="sxs-lookup"><span data-stu-id="e3b43-423">You will navigate to the jQuery library file.</span></span> <span data-ttu-id="e3b43-424">Všimněte si, že se můžete dostat také jQuery souborů pomocí **F12**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-424">Notice you can also navigate across the jQuery files using **F12**.</span></span>

    <span data-ttu-id="e3b43-425">![Přejdete na definice jQuery](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image48.png "přejdete na definice jQuery")</span><span class="sxs-lookup"><span data-stu-id="e3b43-425">![Navigating to jQuery definitions](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image48.png "Navigating to jQuery definitions")</span></span>

    <span data-ttu-id="e3b43-426">*Přejděte na definice jQuery*</span><span class="sxs-lookup"><span data-stu-id="e3b43-426">*Navigating to jQuery definitions*</span></span>

> [!NOTE]
> <span data-ttu-id="e3b43-427">Ujistěte se, že GotoDefinition.js neobsahuje žádné chyby syntaxe před uložením tohoto souboru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-427">Make sure that GotoDefinition.js has no syntax errors before saving the file.</span></span>

<a id="Exercise4"></a>

<a id="Exercise_4_Bundling_and_Minification"></a>
### <a name="exercise-4-bundling-and-minification"></a><span data-ttu-id="e3b43-428">Cvičení 4: Vytváření sady a minifikace</span><span class="sxs-lookup"><span data-stu-id="e3b43-428">Exercise 4: Bundling and Minification</span></span>

<span data-ttu-id="e3b43-429">Kolikrát websites obsahují více než jeden JavaScript nebo šablon stylů CSS soubor?</span><span class="sxs-lookup"><span data-stu-id="e3b43-429">How many times do your websites include more than one JavaScript or CSS file?</span></span> <span data-ttu-id="e3b43-430">Jde o velmi běžný scénář, kde sdružování a minifikace může pomoct snížit velikost souboru a nastavte lokality rychlejší.</span><span class="sxs-lookup"><span data-stu-id="e3b43-430">This is a very common scenario where bundling and minification can help to reduce the file size and make the site perform faster.</span></span> <span data-ttu-id="e3b43-431">Nová funkce pro vytváření prostředků v ASP.NET 4.5 sady sadu soubory JS a CSS do jednoho elementu a snižuje jeho velikost pomocí minifikace obsah (to znamená odebrání mezery nejsou vyžadovány, odebírání komentářů, snížení identifikátory).</span><span class="sxs-lookup"><span data-stu-id="e3b43-431">The new bundling feature in ASP.NET 4.5 packs a set of JS or CSS files into a single element, and reduces its size by minifying the content ( i.e. removing not required blank spaces, removing comments, reducing identifiers ).</span></span>

<span data-ttu-id="e3b43-432">Sdružování a minifikace v technologii ASP.NET 4.5 je provést v době běhu, tak, aby proces identifikace uživatelský agent (např. aplikace Internet Explorer, Mozilla atd.) a proto komprese zlepšit cílení na uživatele prohlížeče (například odebrání položky, který je Mozilla konkrétní Když požadavek pochází z aplikace Internet Explorer).</span><span class="sxs-lookup"><span data-stu-id="e3b43-432">Bundling and minification in ASP.NET 4.5 is performed at runtime, so that the process can identify the user agent (for example IE, Mozilla, etc), and thus, improve the compression by targeting the user browser (for instance, removing stuff that is Mozilla specific when the request comes from IE).</span></span>

<span data-ttu-id="e3b43-433">V tomto cvičení se dozvíte, jak povolit a použít různé typy sdružování a minifikace v technologii ASP.NET 4.5.</span><span class="sxs-lookup"><span data-stu-id="e3b43-433">In this exercise, you will learn how to enable and use the different types of bundling and minification in ASP.NET 4.5.</span></span>

<a id="Ex4Task1"></a>

<a id="Task_1_-_Installing_the_Bundling_and_Minification_Package_from_NuGet"></a>
#### <a name="task-1---installing-the-bundling-and-minification-package-from-nuget"></a><span data-ttu-id="e3b43-434">Úloha 1 – instalace sdružování a Minifikace balíčku od Nugetu</span><span class="sxs-lookup"><span data-stu-id="e3b43-434">Task 1 - Installing the Bundling and Minification Package from NuGet</span></span>

1. <span data-ttu-id="e3b43-435">Pokud ještě není otevřen, začněte **sady Visual Studio** a otevřete **WhatsNewASPNET.sln** řešení nachází v **Source\WhatsNewASPNET** složka tohoto testovacího prostředí.</span><span class="sxs-lookup"><span data-stu-id="e3b43-435">If not already opened, start **Visual Studio** and open the **WhatsNewASPNET.sln** solution located in the **Source\WhatsNewASPNET** folder of this lab.</span></span>
2. <span data-ttu-id="e3b43-436">Otevřete konzolu Správce balíčků NuGet.</span><span class="sxs-lookup"><span data-stu-id="e3b43-436">Open the NuGet Package Manager Console.</span></span> <span data-ttu-id="e3b43-437">K tomuto účelu použijte nabídku **zobrazení** | **ostatní Windows** | **Konzola správce balíčků**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-437">To do this, use the menu **View** | **Other Windows** | **Package Manager Console**.</span></span>

    <span data-ttu-id="e3b43-438">![Otevření správce file:///C:/Users/User/AppData/Local/Temp/Marker3744//media/44462/Multiple-Stylesheets-and-JavaScript-files-in-the-application.pngconsole balíčku](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image49.png "otevřete konzoly Správce balíčků")</span><span class="sxs-lookup"><span data-stu-id="e3b43-438">![Opening the package manager file:///C:/Users/User/AppData/Local/Temp/Marker3744//media/44462/Multiple-Stylesheets-and-JavaScript-files-in-the-application.pngconsole](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image49.png "Opening the package manager console")</span></span>

    <span data-ttu-id="e3b43-439">*Otevření konzole Správce balíčků*</span><span class="sxs-lookup"><span data-stu-id="e3b43-439">*Opening the package manager console*</span></span>
3. <span data-ttu-id="e3b43-440">V **Konzola správce balíčků** typ **Install-Package Microsoft.Web.Optimization** a stiskněte klávesu **ENTER**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-440">In the **Package Manager Console,** type **Install-Package Microsoft.Web.Optimization** and press **ENTER**.</span></span>

<a id="Ex4Task2"></a>

<a id="Task_2_-_Default_Bundles"></a>
#### <a name="task-2---default-bundles"></a><span data-ttu-id="e3b43-441">Úloha 2 – výchozí sady</span><span class="sxs-lookup"><span data-stu-id="e3b43-441">Task 2 - Default Bundles</span></span>

<span data-ttu-id="e3b43-442">Nejjednodušší způsob, jak používat sdružování a minifikace je umožnit výchozí sady.</span><span class="sxs-lookup"><span data-stu-id="e3b43-442">The simplest way to use bundling and minification is to enable the default bundles.</span></span> <span data-ttu-id="e3b43-443">Tato metoda používá konvence umožňuje odkazovat na připojené a minifikovaný verze pro soubory JS a CSS ve složce.</span><span class="sxs-lookup"><span data-stu-id="e3b43-443">This method uses conventions to let you reference the bundled and minified version for the JS and CSS files in a folder.</span></span>

<span data-ttu-id="e3b43-444">V této úloze se dozvíte, jak povolit a odkazovat na připojené a minifikovaný soubory JS a CSS a zobrazit výsledný výstup.</span><span class="sxs-lookup"><span data-stu-id="e3b43-444">In this task, you will learn how to enable and reference the bundled and minified JS and CSS files and view the resulting output.</span></span>

1. <span data-ttu-id="e3b43-445">Pokud ještě není otevřen, začněte **sady Visual Studio** a otevřete **WhatsNewASPNET.sln** řešení nachází v **Source\WhatsNewASPNET** složka tohoto testovacího prostředí.</span><span class="sxs-lookup"><span data-stu-id="e3b43-445">If not already opened, start **Visual Studio** and open the **WhatsNewASPNET.sln** solution located in the **Source\WhatsNewASPNET** folder of this lab.</span></span>
2. <span data-ttu-id="e3b43-446">V **Průzkumníka řešení**, rozbalte **styly**, **Scripts\custom** a **Scripts\bundle** složek.</span><span class="sxs-lookup"><span data-stu-id="e3b43-446">In the **Solution Explorer**, expand the **Styles**, **Scripts\custom** and **Scripts\bundle** folders.</span></span>

    <span data-ttu-id="e3b43-447">Všimněte si, že aplikace používá více než jeden šablon stylů CSS a JS souboru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-447">Notice that the application is using more than one CSS and JS file.</span></span>

    <span data-ttu-id="e3b43-448">![Soubory více šablon stylů a jazyka JavaScript v aplikaci](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image50.png "soubory více šablon stylů a jazyka JavaScript v aplikaci")</span><span class="sxs-lookup"><span data-stu-id="e3b43-448">![Multiple Stylesheets and JavaScript files in the application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image50.png "Multiple Stylesheets and JavaScript files in the application")</span></span>

    <span data-ttu-id="e3b43-449">*Více souborů šablon stylů a jazyka JavaScript v aplikaci*</span><span class="sxs-lookup"><span data-stu-id="e3b43-449">*Multiple Stylesheets and JavaScript files in the application*</span></span>
3. <span data-ttu-id="e3b43-450">Otevřít **Global.asax.cs** souboru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-450">Open the **Global.asax.cs** file.</span></span>

    <span data-ttu-id="e3b43-451">Všimněte si, že nový **Microsoft.Web.Optimization** obor názvů je označené jako komentář na začátku souboru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-451">Notice that the new **Microsoft.Web.Optimization** namespace is commented out at the beginning of the file.</span></span> <span data-ttu-id="e3b43-452">Zrušte komentář na pomocí směrnice obsahují sdružování a minifikace funkce.</span><span class="sxs-lookup"><span data-stu-id="e3b43-452">Uncomment the using directive to include the bundling and minification features.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample10.cs)]
4. <span data-ttu-id="e3b43-453">Vyhledejte **aplikace\_Start** metody.</span><span class="sxs-lookup"><span data-stu-id="e3b43-453">Locate the **Application\_Start** method.</span></span>

    <span data-ttu-id="e3b43-454">V této metodě zrušte komentář u volání EnableDefaultBundles, jak je znázorněno v následujícím fragmentu kódu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-454">In this method, uncomment the EnableDefaultBundles call as shown in the snippet below.</span></span> <span data-ttu-id="e3b43-455">Umožňuje nám to odkazuje na připojené kolekci souborů šablon stylů CSS ve složce pomocí cesty ke složce, plus &quot;šablon stylů CSS&quot; nebo &quot;JS&quot; příponu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-455">This enables us to reference a bundled collection of CSS files in a folder by using the path to that folder, plus the &quot;CSS&quot; or the &quot;JS&quot; suffix.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample11.cs)]
5. <span data-ttu-id="e3b43-456">Otevřít **Optimization.aspx** souboru a vyhledejte ovládací prvek obsahu pro **HeadContent**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-456">Open the **Optimization.aspx** file and locate the content control for **HeadContent**.</span></span>

    <span data-ttu-id="e3b43-457">Všimněte si, že soubory šablon stylů CSS a JS mít jednu značku odkazované.</span><span class="sxs-lookup"><span data-stu-id="e3b43-457">Notice the CSS files and the JS files have a single referenced tag.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample12.aspx)]

    > [!NOTE]
    > <span data-ttu-id="e3b43-458">Tento kód je pro účely ukázky.</span><span class="sxs-lookup"><span data-stu-id="e3b43-458">This code is for demo purposes.</span></span> <span data-ttu-id="e3b43-459">V ideálním případě bude odkazovat sad v souboru Site.Master.</span><span class="sxs-lookup"><span data-stu-id="e3b43-459">Ideally, you will reference the bundles in the Site.Master file.</span></span> <span data-ttu-id="e3b43-460">V tomto ukázkovém kódu zjistíte, že některé soubory v sadě jsou také se na ně odkazovat soubor Site.Master odkazu poslední redundantní.</span><span class="sxs-lookup"><span data-stu-id="e3b43-460">In this sample code, you will find that some of the bundled files are also being referenced by the Site.Master file, making this last reference redundant.</span></span>
6. <span data-ttu-id="e3b43-461">Všimněte si, že odkazy používají konvence vytváření prostředků v **href** atribut zobrazíte všechny šablony stylů CSS a JS soubory z stylů a Scripts\custom složky v uvedeném pořadí.</span><span class="sxs-lookup"><span data-stu-id="e3b43-461">Notice that the links are using the bundling conventions in the **href** attribute to get all the CSS or JS files from the Styles and Scripts\custom folder respectively.</span></span>

    <span data-ttu-id="e3b43-462">Může používat cestu **skripty/vlastní/JS** jak je znázorněno níže, k vytvoření balíčku a minifikace všechny soubory JS v **skripty a vlastní** složky.</span><span class="sxs-lookup"><span data-stu-id="e3b43-462">You can use the path **Scripts/custom/JS** as shown below to bundle and minify all the JS files inside a **Scripts/custom** folder.</span></span> <span data-ttu-id="e3b43-463">Toto je výchozí chování sady výchozí.</span><span class="sxs-lookup"><span data-stu-id="e3b43-463">This is the default behavior with the default bundles.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample13.aspx)]
7. <span data-ttu-id="e3b43-464">Otevřít **Styles\Site.css** souboru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-464">Open the **Styles\Site.css** file.</span></span>

    <span data-ttu-id="e3b43-465">Všimněte si, že původní soubor CSS obsahuje kód odsazený, mezery a komentáře, které zvětšení souboru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-465">Notice that the original CSS file contains indented code, blank spaces and comments that enlarge the file.</span></span> <span data-ttu-id="e3b43-466">(Také soubor jazyka JavaScript obsahuje mezery a komentáře).</span><span class="sxs-lookup"><span data-stu-id="e3b43-466">(Also the JavaScript file contains blank spaces and comments).</span></span>

    <span data-ttu-id="e3b43-467">![Jeden z původní šablony stylů CSS soubory ve složce Scripts](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image51.png "jeden z původní šablony stylů CSS soubory ve složce Scripts")</span><span class="sxs-lookup"><span data-stu-id="e3b43-467">![One of the original CSS files in the Scripts folder](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image51.png "One of the original CSS files in the Scripts folder")</span></span>

    <span data-ttu-id="e3b43-468">*Jeden z původní šablony stylů CSS souborů ve složce Scripts*</span><span class="sxs-lookup"><span data-stu-id="e3b43-468">*One of the original CSS files in the Scripts folder*</span></span>
8. <span data-ttu-id="e3b43-469">Stisknutím klávesy **F5** spusťte aplikaci a přejděte **optimalizace** stránky.</span><span class="sxs-lookup"><span data-stu-id="e3b43-469">Press **F5** to run the application and navigate to the **Optimization** page.</span></span>
9. <span data-ttu-id="e3b43-470">Klikněte na **sady šablon stylů CSS** odkaz ke stažení a otevřete soubor.</span><span class="sxs-lookup"><span data-stu-id="e3b43-470">Click on the **CSS Bundle** link to download and open the file.</span></span>

    <span data-ttu-id="e3b43-471">Projděte si soubor minifikovaný jako součást balíčku.</span><span class="sxs-lookup"><span data-stu-id="e3b43-471">Check out the minified bundled file.</span></span> <span data-ttu-id="e3b43-472">Můžete si všimnout, že byly odebrány všechny mezery, komentáře a odsazení znaků, generování menší soubor.</span><span class="sxs-lookup"><span data-stu-id="e3b43-472">You will notice that all the blank spaces, comments and indentation characters have been removed, generating a smaller file.</span></span>

    <span data-ttu-id="e3b43-473">![Soubory šablon stylů CSS v sadě](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image52.png "soubory balíčků šablon stylů CSS")</span><span class="sxs-lookup"><span data-stu-id="e3b43-473">![Bundled CSS files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image52.png "Bundled CSS files")</span></span>

    <span data-ttu-id="e3b43-474">*Soubory šablon stylů CSS v sadě*</span><span class="sxs-lookup"><span data-stu-id="e3b43-474">*Bundled CSS files*</span></span>
10. <span data-ttu-id="e3b43-475">Nyní klikejte na příkaz **JS sady** odkaz k otevření souboru JavaScriptu spojeny.</span><span class="sxs-lookup"><span data-stu-id="e3b43-475">Now click the **JS Bundle** link to open the JavaScript bundled file.</span></span> <span data-ttu-id="e3b43-476">V Průzkumníku upozornění můžete bezpečně ignorovat.</span><span class="sxs-lookup"><span data-stu-id="e3b43-476">You can safely disregard the explorer warning.</span></span> <span data-ttu-id="e3b43-477">Všimněte si, že soubory jazyka JavaScript v rámci **vlastní** složky jsou taky spojeny a minifikovaný.</span><span class="sxs-lookup"><span data-stu-id="e3b43-477">Notice the JavaScript files under the **custom** folder are also bundled and minified.</span></span>

    <span data-ttu-id="e3b43-478">![Soubory jazyka JavaScript v sadě](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image53.png "soubory balíčků jazyka JavaScript")</span><span class="sxs-lookup"><span data-stu-id="e3b43-478">![Bundled JavaScript files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image53.png "Bundled JavaScript files")</span></span>

    <span data-ttu-id="e3b43-479">*Soubory jazyka JavaScript v sadě*</span><span class="sxs-lookup"><span data-stu-id="e3b43-479">*Bundled JavaScript files*</span></span>

    <span data-ttu-id="e3b43-480">Povolení komprese pro soubory CSS a JS bylo mnohem složitější v předchozí verzi technologie ASP.NET.</span><span class="sxs-lookup"><span data-stu-id="e3b43-480">Enabling compression for CSS or JS files was much more complicated in previous ASP.NET version.</span></span> <span data-ttu-id="e3b43-481">Nyní, jak jste viděli, stačí přidat jeden řádek *Global.asax* soubor povolit sdružování a odkázat na připojené soubory z vašeho webu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-481">Now, as you have seen, you just need to add one line in the *Global.asax* file to enable bundling, and then reference the bundled files from your site.</span></span>

<a id="Ex4Task3"></a>

<a id="Task_3_-_Static_Bundles"></a>
#### <a name="task-3---static-bundles"></a><span data-ttu-id="e3b43-482">Úloha 3 – statické sady</span><span class="sxs-lookup"><span data-stu-id="e3b43-482">Task 3 - Static Bundles</span></span>

<span data-ttu-id="e3b43-483">Statická sada přístupu umožňuje přizpůsobit sadu souborů sady, odkaz a připravenost k minifikaci metodu, která se použije.</span><span class="sxs-lookup"><span data-stu-id="e3b43-483">The static bundle approach allows you to customize the set of files to bundle, the reference and the minification method that will be used.</span></span>

<span data-ttu-id="e3b43-484">V této úlohy můžete nakonfigurovat statické sady definovat konkrétní sadu souborů pro vytvoření balíčku a minifikace.</span><span class="sxs-lookup"><span data-stu-id="e3b43-484">In this task, you will configure a static bundle to define a specific set of files to bundle and minify.</span></span>

1. <span data-ttu-id="e3b43-485">Zavřete prohlížeč.</span><span class="sxs-lookup"><span data-stu-id="e3b43-485">Close the browser.</span></span>
2. <span data-ttu-id="e3b43-486">Otevřít **Global.asax.cs** souboru a vyhledejte **aplikace\_Start** metoda.</span><span class="sxs-lookup"><span data-stu-id="e3b43-486">Open the **Global.asax.cs** file and locate the **Application\_Start** method.</span></span>
3. <span data-ttu-id="e3b43-487">Zrušením komentáře u statické sady kódu, jak je znázorněno v následujícím kódu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-487">Uncomment the static bundle code as shown in the code below.</span></span>

    <span data-ttu-id="e3b43-488">Definování statickou sadu, která se bude odkazovat &quot; **~/StaticBundle** &quot; virtuální cesty a použití **JsMinify** pro minimalizaci všechny zadané soubory s **AddFile** metody.</span><span class="sxs-lookup"><span data-stu-id="e3b43-488">You are defining a static bundle that will be referenced with the &quot;**~/StaticBundle**&quot; virtual path and use **JsMinify** for minification of all the specified files with the **AddFile** method.</span></span> <span data-ttu-id="e3b43-489">Nakonec přidáte statická sada, která má **BundleTable** a že ho povolíte.</span><span class="sxs-lookup"><span data-stu-id="e3b43-489">Finally, you are adding the static bundle to the **BundleTable** and enabling it.</span></span>

    <span data-ttu-id="e3b43-490">Všimněte si, že soubory nejsou umístěny na stejném místě; Toto je Další výhodou nad výchozí sdružování.</span><span class="sxs-lookup"><span data-stu-id="e3b43-490">Notice that the files are not located in the same place; this is another advantage over the default bundling.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample14.cs)]
4. <span data-ttu-id="e3b43-491">Otevřít **Optimization.aspx** souboru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-491">Open the **Optimization.aspx** file.</span></span>

    <span data-ttu-id="e3b43-492">Všimněte si, že odkaz na **statické JS sady** je pomocí cesty je deklarován při konfiguraci sady statických v souboru Global.asax.cs: **/StaticBundle**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-492">Notice that the link to **Static JS Bundle** is using the path you have declared when you configured the static bundle in the Global.asax.cs file: **/StaticBundle**.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample15.aspx)]
5. <span data-ttu-id="e3b43-493">Stisknutím klávesy **F5** ke spuštění aplikace a potom přejděte na **optimalizace** stránky.</span><span class="sxs-lookup"><span data-stu-id="e3b43-493">Press **F5** to run the application, and then navigate to the **Optimization** page.</span></span>
6. <span data-ttu-id="e3b43-494">Klikněte na **statické JS sady** odkaz k otevření souboru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-494">Click on the **Static JS Bundle** link to open the file.</span></span>

    <span data-ttu-id="e3b43-495">Všimněte si, že minifikovaný dodávat soubor jazyka JavaScript je výstup pro všechny soubory jazyka JavaScript nakonfigurovaný v souboru statické sady v rámci cesty &quot;/StaticBundle&quot;.</span><span class="sxs-lookup"><span data-stu-id="e3b43-495">Notice that the minified bundled JavaScript file is the output for all the JavaScript files configured in the static bundle file under the path &quot;/StaticBundle&quot;.</span></span>

    <span data-ttu-id="e3b43-496">![Statické soubory sady JavaScript](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image54.png "sady JavaScript statické soubory")</span><span class="sxs-lookup"><span data-stu-id="e3b43-496">![Static JavaScript files bundle](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image54.png "Static JavaScript files bundle")</span></span>

    <span data-ttu-id="e3b43-497">*Seskupit statické soubory jazyka JavaScript*</span><span class="sxs-lookup"><span data-stu-id="e3b43-497">*Static JavaScript files bundle*</span></span>
7. <span data-ttu-id="e3b43-498">Zavřete prohlížeč a vraťte se do sady Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="e3b43-498">Close the browser and return to Visual Studio.</span></span>

<a id="Ex4Task4"></a>

<a id="Task_4_-_Dynamic_Folder_Bundles"></a>
#### <a name="task-4---dynamic-folder-bundles"></a><span data-ttu-id="e3b43-499">Úloha 4 – dynamické složku sady</span><span class="sxs-lookup"><span data-stu-id="e3b43-499">Task 4 - Dynamic Folder Bundles</span></span>

<span data-ttu-id="e3b43-500">V této úloze se dozvíte, jak nakonfigurovat dynamické složku sady.</span><span class="sxs-lookup"><span data-stu-id="e3b43-500">In this task, you will learn how to configure dynamic folder bundles.</span></span> <span data-ttu-id="e3b43-501">Výkon dynamické sdružování je, že můžete zahrnout statické JavaScript, jakož i jiné soubory v jazycích, které se kompiluje do jazyka JavaScript a proto nevyžadují nějaké zpracování předtím, než se spustí sdružování.</span><span class="sxs-lookup"><span data-stu-id="e3b43-501">The power of dynamic bundling is that you can include static JavaScript, as well as other files in languages that compiles into JavaScript, and thus, require some processing before the bundling is executed.</span></span>

<span data-ttu-id="e3b43-502">V tomto příkladu se dozvíte, jak používat **DynamicFolderBundle** třídy za účelem vytvoření dynamického sada prostředků pro soubory, které jsou napsané v CofeeScript.</span><span class="sxs-lookup"><span data-stu-id="e3b43-502">In this example, you will learn how to use the **DynamicFolderBundle** class to create a dynamic bundle for files written in CofeeScript.</span></span> <span data-ttu-id="e3b43-503">CofeeScript je programovací jazyk, který kompiluje do jazyka JavaScript a nabízí jednodušší syntaxí pro psaní kódu jazyka JavaScript, lepší čitelnost a zkrácení v jazyce JavaScript.</span><span class="sxs-lookup"><span data-stu-id="e3b43-503">CofeeScript is a programming language that compiles into JavaScript and provides a simpler syntax for writing JavaScript code, enhancing JavaScript's brevity and readability.</span></span>

1. <span data-ttu-id="e3b43-504">Otevřít **Global.asax.cs** souboru a vyhledejte **aplikace\_Start** metoda.</span><span class="sxs-lookup"><span data-stu-id="e3b43-504">Open the **Global.asax.cs** file and locate the **Application\_Start** method.</span></span>
2. <span data-ttu-id="e3b43-505">Zrušením komentáře u dynamických sady kódu, jak je znázorněno v následujícím kódu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-505">Uncomment the dynamic bundle code as shown in the code below.</span></span>

    <span data-ttu-id="e3b43-506">Definujete sadu dynamické složku, která bude používat **CoffeeMinify** připravenost k minifikaci vlastní procesor, který se bude vztahovat jenom na soubory s &quot; **.coffee** &quot; (rozšíření Soubory CoffeeScript).</span><span class="sxs-lookup"><span data-stu-id="e3b43-506">You are defining a dynamic folder bundle that will use the **CoffeeMinify** custom minification processor that will only apply to the files with the &quot;**.coffee**&quot; extension (CoffeeScript files).</span></span> <span data-ttu-id="e3b43-507">Všimněte si, že můžete použít vzor hledání pro výběr souborů pro vytvoření balíčku ve složce, jako je třeba "\*.coffee".</span><span class="sxs-lookup"><span data-stu-id="e3b43-507">Notice that you can use a search pattern to select the files to bundle within a folder, like '\*.coffee'.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample16.cs)]
3. <span data-ttu-id="e3b43-508">Otevřete konzolu Správce balíčků NuGet.</span><span class="sxs-lookup"><span data-stu-id="e3b43-508">Open the NuGet Package Manager Console.</span></span> <span data-ttu-id="e3b43-509">K tomuto účelu použijte nabídku **zobrazení** | **ostatní Windows** | **Konzola správce balíčků**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-509">To do this, use the menu **View** | **Other Windows** | **Package Manager Console**.</span></span>
4. <span data-ttu-id="e3b43-510">V **Konzola správce balíčků** typ **Install-Package CoffeeSharp** a stiskněte klávesu **ENTER**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-510">In the **Package Manager Console,** type **Install-Package CoffeeSharp** and press **ENTER**.</span></span>
5. <span data-ttu-id="e3b43-511">Klikněte na tlačítko **zobrazit všechny soubory** tlačítko **Průzkumníka řešení** okna</span><span class="sxs-lookup"><span data-stu-id="e3b43-511">Click the **Show All Files** button in the **Solution Explorer** window</span></span>

    <span data-ttu-id="e3b43-512">![Zobrazení všech souborů](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image55.png "zobrazující všechny soubory")</span><span class="sxs-lookup"><span data-stu-id="e3b43-512">![Showing all files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image55.png "Showing all files")</span></span>

    <span data-ttu-id="e3b43-513">*Zobrazení všech souborů*</span><span class="sxs-lookup"><span data-stu-id="e3b43-513">*Showing all files*</span></span>
6. <span data-ttu-id="e3b43-514">Klikněte pravým tlačítkem myši **CoffeeMinify.cs** soubor **Průzkumníku řešení** a vyberte **zahrnout do projektu**</span><span class="sxs-lookup"><span data-stu-id="e3b43-514">Right click the **CoffeeMinify.cs** file in the **Solution Explorer** and select **Include in Project**</span></span>

    <span data-ttu-id="e3b43-515">![Zahrnout do projektu soubor CoffeeMinify.cs](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image56.png "CoffeeMinify.cs soubor zahrnout projektu")</span><span class="sxs-lookup"><span data-stu-id="e3b43-515">![Include the CoffeeMinify.cs file in the project](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image56.png "Include the CoffeeMinify.cs file in the project")</span></span>

    <span data-ttu-id="e3b43-516">*Zahrnout soubor CoffeeMinify.cs do projektu*</span><span class="sxs-lookup"><span data-stu-id="e3b43-516">*Include the CoffeeMinify.cs file in the project*</span></span>
7. <span data-ttu-id="e3b43-517">Otevřít **CoffeeMinify.cs** souboru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-517">Open the **CoffeeMinify.cs** file.</span></span>

    <span data-ttu-id="e3b43-518">Tato třída dědí z JsMinify k minifikaci Javascriptového výstupu plynoucí z kompilování kódu CoffeeScript.</span><span class="sxs-lookup"><span data-stu-id="e3b43-518">This class inherits from JsMinify to minify the JavaScript output resulting from the CoffeeScript code compilation.</span></span> <span data-ttu-id="e3b43-519">Volá CoffeeScript kompilátor nejprve generovat kód jazyka JavaScript, a potom ho odešle JsMinify.Process metody k minifikaci výsledný kód.</span><span class="sxs-lookup"><span data-stu-id="e3b43-519">It calls the CoffeeScript compiler to generate the JavaScript code first, and then it sends it to the JsMinify.Process method to minify the resulting code.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample17.cs)]
8. <span data-ttu-id="e3b43-520">Otevřít **Script1.coffee** a **Script2.coffee** souborů z doručené pošty **skripty/sady** složky.</span><span class="sxs-lookup"><span data-stu-id="e3b43-520">Open the **Script1.coffee** and **Script2.coffee** files from the **Scripts/bundle** folder.</span></span>

    <span data-ttu-id="e3b43-521">Tyto soubory bude obsahovat CoffeScript kód se zkompiluje při provádění sdružování s třídou CoffeeMinify.</span><span class="sxs-lookup"><span data-stu-id="e3b43-521">These files will include the CoffeScript code to be compiled while performing the bundling with the CoffeeMinify class.</span></span>

    <span data-ttu-id="e3b43-522">V zájmu jednoduchosti soubory CoffeeScript k dispozici jsou pouze včetně CoffeeScript ukázkový kód.</span><span class="sxs-lookup"><span data-stu-id="e3b43-522">For simplicity purposes, the CoffeeScript files provided are only including CoffeeScript sample code.</span></span> <span data-ttu-id="e3b43-523">Komentáře jsou vyloučeny JsMinify procesem.</span><span class="sxs-lookup"><span data-stu-id="e3b43-523">The comments are excluded by the JsMinify process.</span></span>

    <span data-ttu-id="e3b43-524">![Soubory CoffeeScript](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image57.png "soubory CoffeeScript")</span><span class="sxs-lookup"><span data-stu-id="e3b43-524">![CoffeeScript files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image57.png "CoffeeScript files")</span></span>

    <span data-ttu-id="e3b43-525">*Soubory CoffeeScript*</span><span class="sxs-lookup"><span data-stu-id="e3b43-525">*CoffeeScript files*</span></span>

    > [!NOTE]
    > <span data-ttu-id="e3b43-526">[CofeeScript](https://github.com/jashkenas/coffeescript/) nabízí jednodušší syntaxi pro psaní kódu jazyka JavaScript, zkrácení v jazyce JavaScript a čitelnost, stejně jako přidávání jiných funkcí, jako je obsah pole a porovnávání vzorů.</span><span class="sxs-lookup"><span data-stu-id="e3b43-526">[CofeeScript](https://github.com/jashkenas/coffeescript/) provides a simpler syntax for writing JavaScript code, enhancing JavaScript's brevity and readability, as well as adding other features like array comprehension and pattern matching.</span></span>
9. <span data-ttu-id="e3b43-527">Otevřít **Optimization.aspx** souboru a vyhledejte odkazy sady.</span><span class="sxs-lookup"><span data-stu-id="e3b43-527">Open the **Optimization.aspx** file and locate the bundle links.</span></span>

    <span data-ttu-id="e3b43-528">Všimněte si, že odkaz na **dynamické JS sady** odkazuje **skripty/sady** složky pomocí **/kávy** přípony, které jste nakonfigurovali pro sadu složek dynamické.</span><span class="sxs-lookup"><span data-stu-id="e3b43-528">Notice that the link to **Dynamic JS Bundle** is referencing the **Scripts/bundle** folder by using the **/Coffee** suffix you configured for the dynamic folder bundle.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample18.aspx)]
10. <span data-ttu-id="e3b43-529">Stisknutím klávesy **F5** ke spuštění aplikace a potom přejděte na **optimalizace** stránky.</span><span class="sxs-lookup"><span data-stu-id="e3b43-529">Press **F5** to run the application, and then navigate to the **Optimization** page.</span></span>
11. <span data-ttu-id="e3b43-530">Klikněte na **dynamické JS sady** odkaz k otevření generovaného souboru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-530">Click on the **Dynamic JS Bundle** link to open the generated file.</span></span>

    <span data-ttu-id="e3b43-531">Všimněte si, že obsah, který byl součástí Tato sada obsahuje pouze **.coffee** soubory.</span><span class="sxs-lookup"><span data-stu-id="e3b43-531">Notice that the content that was included in this bundle only contains **.coffee** files.</span></span> <span data-ttu-id="e3b43-532">Můžete také zobrazit, že kód CoffeeScript byla zkompilována do jazyka JavaScript a komentovaná řádky se odebrala.</span><span class="sxs-lookup"><span data-stu-id="e3b43-532">You can also see that the CoffeeScript code was compiled to JavaScript and the commented-out lines has been removed.</span></span>

    <span data-ttu-id="e3b43-533">![Dynamické soubory JS sady](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image58.png "dynamické JS sady souborů")</span><span class="sxs-lookup"><span data-stu-id="e3b43-533">![Dynamic JS files bundle](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image58.png "Dynamic JS files bundle")</span></span>

    <span data-ttu-id="e3b43-534">*Dynamické sady soubory JS*</span><span class="sxs-lookup"><span data-stu-id="e3b43-534">*Dynamic JS files bundle*</span></span>

> [!NOTE]
> <span data-ttu-id="e3b43-535">Kromě toho můžete nasadit tuto aplikaci následující weby Windows Azure [příloha B: Publikování aplikace ASP.NET MVC 4 pomocí nasazení webu](#AppendixB).</span><span class="sxs-lookup"><span data-stu-id="e3b43-535">Additionally, you can deploy this application to Windows Azure Web Sites following [Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy](#AppendixB).</span></span>

<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="e3b43-536">Souhrn</span><span class="sxs-lookup"><span data-stu-id="e3b43-536">Summary</span></span>

<span data-ttu-id="e3b43-537">Toto testovací prostředí vám umožní pochopit, co je nového v ASP.NET a vývoj v sadě Visual Studio 2012 pro Web a jak využívat řadu vylepšení v sadě Visual Studio 2012.</span><span class="sxs-lookup"><span data-stu-id="e3b43-537">This lab helps you to understand what New in ASP.NET and Web Development in Visual Studio 2012 is and how to take advantage of the variety of enhancements in Visual Studio 2012.</span></span>

<span data-ttu-id="e3b43-538">Po dokončení tohoto praktického testovacího prostředí, mají zkušenosti použití nových funkcí a vylepšení v aplikaci Visual Studio 2012 editory pro šablony stylů CSS, JavaScript a HTML.</span><span class="sxs-lookup"><span data-stu-id="e3b43-538">By completing this Hands-On Lab, you have learnt how to use the new features and improvements in Visual Studio 2012 Editors for CSS, JavaScript and HTML.</span></span> <span data-ttu-id="e3b43-539">Kromě toho mají zkušenosti, jak Visual Studio 2012 implementuje integrované sdružování a minifikace.</span><span class="sxs-lookup"><span data-stu-id="e3b43-539">In addition, you have learnt how Visual Studio 2012 implements built-in bundling and minification.</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="e3b43-540">Příloha A: Instalace sady Visual Studio Express 2012 pro Web</span><span class="sxs-lookup"><span data-stu-id="e3b43-540">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="e3b43-541">Můžete nainstalovat **Microsoft Visual Studio Express 2012 pro Web** nebo jiném &quot;Express&quot; verzí pomocí **[instalačního programu webové platformy Microsoft](https://www.microsoft.com/web/downloads/platform.aspx)**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-541">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="e3b43-542">Postupujte podle následujících pokynů vás provede kroky potřebné k instalaci *Visual studio Express 2012 pro Web* pomocí *instalačního programu webové platformy Microsoft*.</span><span class="sxs-lookup"><span data-stu-id="e3b43-542">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="e3b43-543">Přejděte na [ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="e3b43-543">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="e3b43-544">Případně, pokud jste již nainstalovali instalačního programu webové platformy, můžete otevřít a vyhledejte produkt &quot; <em>Visual Studio Express 2012 pro Web se sadou Windows Azure SDK</em>&quot;.</span><span class="sxs-lookup"><span data-stu-id="e3b43-544">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="e3b43-545">Klikněte na **nainstalovat**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-545">Click on **Install Now**.</span></span> <span data-ttu-id="e3b43-546">Pokud nemáte **instalačního programu webové platformy** budete přesměrováni na stáhněte a nainstalujte ji jako první.</span><span class="sxs-lookup"><span data-stu-id="e3b43-546">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="e3b43-547">Jednou **instalačního programu webové platformy** je otevřený, klikněte na tlačítko **nainstalovat** spustit instalační program.</span><span class="sxs-lookup"><span data-stu-id="e3b43-547">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="e3b43-548">![Instalace sady Visual Studio Express](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image59.png "instalace sady Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="e3b43-548">![Install Visual Studio Express](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image59.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="e3b43-549">*Instalace sady Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="e3b43-549">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="e3b43-550">Čtení všech produktů licence a podmínky a klikněte na tlačítko **souhlasím** pokračujte.</span><span class="sxs-lookup"><span data-stu-id="e3b43-550">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Přijetí podmínek licence](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image60.png)

    <span data-ttu-id="e3b43-552">*Přijetí podmínek licence*</span><span class="sxs-lookup"><span data-stu-id="e3b43-552">*Accepting the license terms*</span></span>
5. <span data-ttu-id="e3b43-553">Počkejte na dokončení procesu stahování a instalaci.</span><span class="sxs-lookup"><span data-stu-id="e3b43-553">Wait until the downloading and installation process completes.</span></span>

    ![Průběh instalace](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image61.png)

    <span data-ttu-id="e3b43-555">*Průběh instalace*</span><span class="sxs-lookup"><span data-stu-id="e3b43-555">*Installation progress*</span></span>
6. <span data-ttu-id="e3b43-556">Až instalace skončí, klikněte na tlačítko **Dokončit**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-556">When the installation completes, click **Finish**.</span></span>

    ![Instalace byla dokončena.](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image62.png)

    <span data-ttu-id="e3b43-558">*Instalace byla dokončena.*</span><span class="sxs-lookup"><span data-stu-id="e3b43-558">*Installation completed*</span></span>
7. <span data-ttu-id="e3b43-559">Klikněte na tlačítko **ukončovací** zavřete instalačního programu webové platformy.</span><span class="sxs-lookup"><span data-stu-id="e3b43-559">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="e3b43-560">Chcete-li spustit nástroj Visual Studio Express for Web, přejděte **Start** obrazovky a začít psát &quot; **VS Express**&quot;, klikněte na **VS Express for Web** dlaždice.</span><span class="sxs-lookup"><span data-stu-id="e3b43-560">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express for Web dlaždice](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image63.png)

    <span data-ttu-id="e3b43-562">*VS Express for Web dlaždice*</span><span class="sxs-lookup"><span data-stu-id="e3b43-562">*VS Express for Web tile*</span></span>
...
## <a name="appendix-b-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="e3b43-563">Příloha B: Publikování aplikace ASP.NET MVC 4 pomocí nasazení webu</span><span class="sxs-lookup"><span data-stu-id="e3b43-563">Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

<span data-ttu-id="e3b43-564">Tento dodatek se ukazují, jak vytvořit nový web z portálu správy Windows Azure a publikovat aplikace, kterou jste získali podle testovacího prostředí, využít Webdeploy funkce publikování ve Windows Azure k dispozici.</span><span class="sxs-lookup"><span data-stu-id="e3b43-564">This appendix will show you how to create a new web site from the Windows Azure Management Portal and publish the application you obtained by following the lab, taking advantage of the Web Deploy publishing feature provided by Windows Azure.</span></span>

<a id="Ex1Task1"></a>

<a id="Task_1_-_Creating_a_New_Web_Site_from_the_Windows_Azure_Portal"></a>
#### <a name="task-1---creating-a-new-web-site-from-the-windows-azure-portal"></a><span data-ttu-id="e3b43-565">Úloha 1 – Vytvoření nového webu z Windows webu Azure Portal</span><span class="sxs-lookup"><span data-stu-id="e3b43-565">Task 1 - Creating a New Web Site from the Windows Azure Portal</span></span>

1. <span data-ttu-id="e3b43-566">Přejděte [Windows Azure Management Portal](https://manage.windowsazure.com/) a přihlaste se pomocí přihlašovacích údajů Microsoft spojených s vaším předplatným.</span><span class="sxs-lookup"><span data-stu-id="e3b43-566">Go to the [Windows Azure Management Portal](https://manage.windowsazure.com/) and sign in using the Microsoft credentials associated with your subscription.</span></span>

    > [!NOTE]
    > <span data-ttu-id="e3b43-567">Windows Azure můžete zadarmo hostovat 10 webů ASP.NET a pak škálujte podle rozšiřujícího se provozu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-567">With Windows Azure you can host 10 ASP.NET Web Sites for free and then scale as your traffic grows.</span></span> <span data-ttu-id="e3b43-568">Můžete se zaregistrovat [tady](https://aka.ms/aspnet-hol-azure).</span><span class="sxs-lookup"><span data-stu-id="e3b43-568">You can sign up [here](https://aka.ms/aspnet-hol-azure).</span></span>

    <span data-ttu-id="e3b43-569">![Přihlaste se k portálu Windows Azure](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image64.png "Přihlaste se k portálu Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="e3b43-569">![Log on to Windows Azure portal](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image64.png "Log on to Windows Azure portal")</span></span>

    <span data-ttu-id="e3b43-570">*Přihlaste se k portálu pro správu Azure Windows*</span><span class="sxs-lookup"><span data-stu-id="e3b43-570">*Log on to Windows Azure Management Portal*</span></span>
2. <span data-ttu-id="e3b43-571">Klikněte na tlačítko **nový** na panelu příkazů.</span><span class="sxs-lookup"><span data-stu-id="e3b43-571">Click **New** on the command bar.</span></span>

    <span data-ttu-id="e3b43-572">![Vytvoření nového webu](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image65.png "vytváření nového webu")</span><span class="sxs-lookup"><span data-stu-id="e3b43-572">![Creating a new Web Site](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image65.png "Creating a new Web Site")</span></span>

    <span data-ttu-id="e3b43-573">*Vytvoření nového webu*</span><span class="sxs-lookup"><span data-stu-id="e3b43-573">*Creating a new Web Site*</span></span>
3. <span data-ttu-id="e3b43-574">Klikněte na tlačítko **Compute** | **webu**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-574">Click **Compute** | **Web Site**.</span></span> <span data-ttu-id="e3b43-575">Potom vyberte **rychlé vytvoření** možnost.</span><span class="sxs-lookup"><span data-stu-id="e3b43-575">Then select **Quick Create** option.</span></span> <span data-ttu-id="e3b43-576">Zadejte adresu URL k dispozici pro nový web a klikněte na tlačítko **vytvořit web**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-576">Provide an available URL for the new web site and click **Create Web Site**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="e3b43-577">Hostitel pro webovou aplikaci spuštěnou v cloudu, který může řídit a spravovat je web Windows Azure.</span><span class="sxs-lookup"><span data-stu-id="e3b43-577">A Windows Azure Web Site is the host for a web application running in the cloud that you can control and manage.</span></span> <span data-ttu-id="e3b43-578">Možnost rychle vytvořit můžete nasadit hotové webové aplikace na Windows Azure web z mimo portál.</span><span class="sxs-lookup"><span data-stu-id="e3b43-578">The Quick Create option allows you to deploy a completed web application to the Windows Azure Web Site from outside the portal.</span></span> <span data-ttu-id="e3b43-579">Nezahrnuje kroky pro vytvoření databáze.</span><span class="sxs-lookup"><span data-stu-id="e3b43-579">It does not include steps for setting up a database.</span></span>

    <span data-ttu-id="e3b43-580">![Vytvoření nového webu pomocí metody rychlého vytvoření](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image66.png "vytváření nového webu pomocí metody rychlého vytvoření")</span><span class="sxs-lookup"><span data-stu-id="e3b43-580">![Creating a new Web Site using Quick Create](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image66.png "Creating a new Web Site using Quick Create")</span></span>

    <span data-ttu-id="e3b43-581">*Vytvoření nového webu pomocí metody rychlého vytvoření*</span><span class="sxs-lookup"><span data-stu-id="e3b43-581">*Creating a new Web Site using Quick Create*</span></span>
4. <span data-ttu-id="e3b43-582">Počkejte, dokud nové **webu** se vytvoří.</span><span class="sxs-lookup"><span data-stu-id="e3b43-582">Wait until the new **Web Site** is created.</span></span>
5. <span data-ttu-id="e3b43-583">Po vytvoření webové stránky, klikněte na odkaz v části **URL** sloupce.</span><span class="sxs-lookup"><span data-stu-id="e3b43-583">Once the Web Site is created click the link under the **URL** column.</span></span> <span data-ttu-id="e3b43-584">Zkontrolujte, jestli funguje nový web.</span><span class="sxs-lookup"><span data-stu-id="e3b43-584">Check that the new Web Site is working.</span></span>

    <span data-ttu-id="e3b43-585">![Na nový web](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image67.png "přechodu na nový web")</span><span class="sxs-lookup"><span data-stu-id="e3b43-585">![Browsing to the new web site](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image67.png "Browsing to the new web site")</span></span>

    <span data-ttu-id="e3b43-586">*Procházení na nový web*</span><span class="sxs-lookup"><span data-stu-id="e3b43-586">*Browsing to the new web site*</span></span>

    <span data-ttu-id="e3b43-587">![Spuštění webu](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image68.png "spuštění webové stránky")</span><span class="sxs-lookup"><span data-stu-id="e3b43-587">![Web site running](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image68.png "Web site running")</span></span>

    <span data-ttu-id="e3b43-588">*Spuštění webové stránky*</span><span class="sxs-lookup"><span data-stu-id="e3b43-588">*Web site running*</span></span>
6. <span data-ttu-id="e3b43-589">Přejděte zpět na portál a klikněte na název webové stránky v části **název** sloupec, který se zobrazí na stránkách správy.</span><span class="sxs-lookup"><span data-stu-id="e3b43-589">Go back to the portal and click the name of the web site under the **Name** column to display the management pages.</span></span>

    <span data-ttu-id="e3b43-590">![Otevřete správu webových stránek](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image69.png "otevřete správu webových stránek")</span><span class="sxs-lookup"><span data-stu-id="e3b43-590">![Opening the web site management pages](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image69.png "Opening the web site management pages")</span></span>

    <span data-ttu-id="e3b43-591">*Otevřete správu webových stránek*</span><span class="sxs-lookup"><span data-stu-id="e3b43-591">*Opening the Web Site management pages*</span></span>
7. <span data-ttu-id="e3b43-592">V **řídicí panel** stránce v části **rychlý přehled** klikněte na tlačítko **stáhnout profil publikování** odkaz.</span><span class="sxs-lookup"><span data-stu-id="e3b43-592">In the **Dashboard** page, under the **quick glance** section, click the **Download publish profile** link.</span></span>

    > [!NOTE]
    > <span data-ttu-id="e3b43-593">*Profil publikování* obsahuje všechny informace požadované pro publikování webových aplikací na webu Windows Azure pro každou metodu povoleno publikování.</span><span class="sxs-lookup"><span data-stu-id="e3b43-593">The *publish profile* contains all of the information required to publish a web application to a Windows Azure website for each enabled publication method.</span></span> <span data-ttu-id="e3b43-594">Profil publikování obsahuje adresy URL, přihlašovací údaje uživatele a databázové řetězce požadované k připojení a ověřování na základě jednotlivých koncových bodů, u kterých je povolena metoda publikace.</span><span class="sxs-lookup"><span data-stu-id="e3b43-594">The publish profile contains the URLs, user credentials and database strings required to connect to and authenticate against each of the endpoints for which a publication method is enabled.</span></span> <span data-ttu-id="e3b43-595">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** a **Microsoft Visual Studio 2012** podporují čtení publikační profily k automatizaci konfigurace z těchto programů pro publikování webových aplikací na Windows Azure websites.</span><span class="sxs-lookup"><span data-stu-id="e3b43-595">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** and **Microsoft Visual Studio 2012** support reading publish profiles to automate configuration of these programs for publishing web applications to Windows Azure websites.</span></span>

    <span data-ttu-id="e3b43-596">![Stahování webové stránky publikovat profil](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image70.png "stahování webové stránky profil publikování")</span><span class="sxs-lookup"><span data-stu-id="e3b43-596">![Downloading the web site publish profile](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image70.png "Downloading the web site publish profile")</span></span>

    <span data-ttu-id="e3b43-597">*Na webu stažení profilu publikování*</span><span class="sxs-lookup"><span data-stu-id="e3b43-597">*Downloading the Web Site publish profile*</span></span>
8. <span data-ttu-id="e3b43-598">Stáhněte si soubor profilu publikování do vhodného umístění.</span><span class="sxs-lookup"><span data-stu-id="e3b43-598">Download the publish profile file to a known location.</span></span> <span data-ttu-id="e3b43-599">Dále v tomto cvičení uvidíte jak publikovat webovou aplikaci na weby Windows Azure ze sady Visual Studio pomocí tohoto souboru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-599">Further in this exercise you will see how to use this file to publish a web application to a Windows Azure Web Sites from Visual Studio.</span></span>

    <span data-ttu-id="e3b43-600">![Ukládání souboru profilu publikování](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image71.png "ukládá se profil publikování")</span><span class="sxs-lookup"><span data-stu-id="e3b43-600">![Saving the publish profile file](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image71.png "Saving the publish profile")</span></span>

    <span data-ttu-id="e3b43-601">*Ukládá se profil publikování*</span><span class="sxs-lookup"><span data-stu-id="e3b43-601">*Saving the publish profile file*</span></span>

<a id="Ex1Task2"></a>

<a id="Task_2_-_Configuring_the_Database_Server"></a>
#### <a name="task-2---configuring-the-database-server"></a><span data-ttu-id="e3b43-602">Úloha 2 – konfigurování serveru databáze</span><span class="sxs-lookup"><span data-stu-id="e3b43-602">Task 2 - Configuring the Database Server</span></span>

<span data-ttu-id="e3b43-603">Pokud vaše aplikace využívá SQL Server databáze, budete muset vytvořit server služby SQL Database.</span><span class="sxs-lookup"><span data-stu-id="e3b43-603">If your application makes use of SQL Server databases you will need to create a SQL Database server.</span></span> <span data-ttu-id="e3b43-604">Pokud chcete nasadit jednoduchou aplikaci, která nepoužívá SQL Server může tuto úlohu přeskočit.</span><span class="sxs-lookup"><span data-stu-id="e3b43-604">If you want to deploy a simple application that does not use SQL Server you might skip this task.</span></span>

1. <span data-ttu-id="e3b43-605">Pro uložení databáze aplikace budete potřebovat databázi SQL serveru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-605">You will need a SQL Database server for storing the application database.</span></span> <span data-ttu-id="e3b43-606">Servery SQL Database můžete zobrazit ze svého předplatného na portálu správy Windows Azure na **databází Sql** | **servery** | **serveru Řídicí panel**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-606">You can view the SQL Database servers from your subscription in the Windows Azure Management portal at **Sql Databases** | **Servers** | **Server's Dashboard**.</span></span> <span data-ttu-id="e3b43-607">Pokud nemáte server vytvořili, můžete vytvořit jednu **přidat** tlačítko na panelu příkazů.</span><span class="sxs-lookup"><span data-stu-id="e3b43-607">If you do not have a server created, you can create one using the **Add** button on the command bar.</span></span> <span data-ttu-id="e3b43-608">Poznamenejte si **název serveru a adresu URL, správce přihlašovací jméno a heslo**, jak je použijete v další úkoly.</span><span class="sxs-lookup"><span data-stu-id="e3b43-608">Take note of the **server name and URL, administrator login name and password**, as you will use them in the next tasks.</span></span> <span data-ttu-id="e3b43-609">Nevytvářet databáze, protože vytvoří se v pozdější fázi.</span><span class="sxs-lookup"><span data-stu-id="e3b43-609">Do not create the database yet, as it will be created in a later stage.</span></span>

    <span data-ttu-id="e3b43-610">![Řídicí panel serveru SQL Database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image72.png "řídicího panelu serveru SQL Database")</span><span class="sxs-lookup"><span data-stu-id="e3b43-610">![SQL Database Server Dashboard](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image72.png "SQL Database Server Dashboard")</span></span>

    <span data-ttu-id="e3b43-611">*Řídicí panel serveru SQL Database*</span><span class="sxs-lookup"><span data-stu-id="e3b43-611">*SQL Database Server Dashboard*</span></span>
2. <span data-ttu-id="e3b43-612">V dalším úkolem budete testovat připojení k databázi ze sady Visual Studio z tohoto důvodu je nutné zahrnout místní IP adresa serveru seznamu **povolené IP adresy**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-612">In the next task you will test the database connection from Visual Studio, for that reason you need to include your local IP address in the server's list of **Allowed IP Addresses**.</span></span> <span data-ttu-id="e3b43-613">Chcete-li to mohli udělat, klikněte na tlačítko **konfigurovat**, vyberte IP adresu z **aktuální IP adresa klienta** a vložte ho na **počáteční IP adresa** a **Koncová IP adresa** textová pole.</span><span class="sxs-lookup"><span data-stu-id="e3b43-613">To do that, click **Configure**, select the IP address from **Current Client IP Address** and paste it on the **Start IP Address** and **End IP Address** text boxes.</span></span> <span data-ttu-id="e3b43-614">Zadejte název pravidla a klikněte na tlačítko ![add-client-ip-address-ok-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image73.png) tlačítko.</span><span class="sxs-lookup"><span data-stu-id="e3b43-614">Enter a name for the rule and click the ![add-client-ip-address-ok-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image73.png) button.</span></span>

    ![Přidat IP adresu klienta](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image74.png)

    <span data-ttu-id="e3b43-616">*Přidat IP adresu klienta*</span><span class="sxs-lookup"><span data-stu-id="e3b43-616">*Adding Client IP Address*</span></span>
3. <span data-ttu-id="e3b43-617">Jednou **IP adresa klienta** je přidat do povolených IP adres klikněte na tlačítko na **Uložit** potvrďte provedené změny.</span><span class="sxs-lookup"><span data-stu-id="e3b43-617">Once the **Client IP Address** is added to the allowed IP addresses list, click on **Save** to confirm the changes.</span></span>

    ![Potvrzení změn](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image75.png)

    <span data-ttu-id="e3b43-619">*Potvrzení změn*</span><span class="sxs-lookup"><span data-stu-id="e3b43-619">*Confirm Changes*</span></span>

<a id="Ex1Task3"></a>

<a id="Task_3_-_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
#### <a name="task-3---publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="e3b43-620">Úloha 3 – publikování aplikace ASP.NET MVC 4 pomocí nasazení webu</span><span class="sxs-lookup"><span data-stu-id="e3b43-620">Task 3 - Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

1. <span data-ttu-id="e3b43-621">Vraťte se do řešení ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="e3b43-621">Go back to the ASP.NET MVC 4 solution.</span></span> <span data-ttu-id="e3b43-622">V **Průzkumníka řešení**, klikněte pravým tlačítkem na webový projekt a vyberte **publikovat**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-622">In the **Solution Explorer**, right-click the web site project and select **Publish**.</span></span>

    <span data-ttu-id="e3b43-623">![Publikování aplikace](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image76.png "publikování aplikace")</span><span class="sxs-lookup"><span data-stu-id="e3b43-623">![Publishing the Application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image76.png "Publishing the Application")</span></span>

    <span data-ttu-id="e3b43-624">*Publikování na webu*</span><span class="sxs-lookup"><span data-stu-id="e3b43-624">*Publishing the web site*</span></span>
2. <span data-ttu-id="e3b43-625">Importujte profil publikování, který jste uložili v první úloze.</span><span class="sxs-lookup"><span data-stu-id="e3b43-625">Import the publish profile you saved in the first task.</span></span>

    <span data-ttu-id="e3b43-626">![Import profilu publikování](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image77.png "import profilu publikování")</span><span class="sxs-lookup"><span data-stu-id="e3b43-626">![Importing the publish profile](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image77.png "Importing the publish profile")</span></span>

    <span data-ttu-id="e3b43-627">*Import publikačního profilu*</span><span class="sxs-lookup"><span data-stu-id="e3b43-627">*Importing publish profile*</span></span>
3. <span data-ttu-id="e3b43-628">Klikněte na tlačítko **ověřit připojení**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-628">Click **Validate Connection**.</span></span> <span data-ttu-id="e3b43-629">Po dokončení ověření klikněte na tlačítko **Další**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-629">Once Validation is complete click **Next**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="e3b43-630">Ověření bylo dokončeno, jakmile se zobrazí zelené zaškrtnutí vedle tlačítka ověřit připojení.</span><span class="sxs-lookup"><span data-stu-id="e3b43-630">Validation is complete once you see a green checkmark appear next to the Validate Connection button.</span></span>

    <span data-ttu-id="e3b43-631">![Ověřuje se připojení](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image78.png "ověřuje se připojení")</span><span class="sxs-lookup"><span data-stu-id="e3b43-631">![Validating connection](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image78.png "Validating connection")</span></span>

    <span data-ttu-id="e3b43-632">*Ověřuje se připojení*</span><span class="sxs-lookup"><span data-stu-id="e3b43-632">*Validating connection*</span></span>
4. <span data-ttu-id="e3b43-633">V **nastavení** stránce v části **databází** klikněte na tlačítko vedle textového pole připojení k databázi (to znamená **objekt DefaultConnection**).</span><span class="sxs-lookup"><span data-stu-id="e3b43-633">In the **Settings** page, under the **Databases** section, click the button next to your database connection's textbox (i.e. **DefaultConnection**).</span></span>

    <span data-ttu-id="e3b43-634">![Konfigurace nasazení webu](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image79.png "konfigurace nasazení webu")</span><span class="sxs-lookup"><span data-stu-id="e3b43-634">![Web deploy configuration](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image79.png "Web deploy configuration")</span></span>

    <span data-ttu-id="e3b43-635">*Konfigurace nasazení webu*</span><span class="sxs-lookup"><span data-stu-id="e3b43-635">*Web deploy configuration*</span></span>
5. <span data-ttu-id="e3b43-636">Konfigurace připojení k databázi následujícím způsobem:</span><span class="sxs-lookup"><span data-stu-id="e3b43-636">Configure the database connection as follows:</span></span>

   - <span data-ttu-id="e3b43-637">V **název serveru** zadejte vaše pomocí adresy URL databáze SQL serveru *tcp:* předponu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-637">In the **Server name** type your SQL Database server URL using the *tcp:* prefix.</span></span>
   - <span data-ttu-id="e3b43-638">V **uživatelské jméno** zadejte vaše přihlašovací jméno správce serveru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-638">In **User name** type your server administrator login name.</span></span>
   - <span data-ttu-id="e3b43-639">V **heslo** zadejte heslo pro přihlašovací jméno správce serveru.</span><span class="sxs-lookup"><span data-stu-id="e3b43-639">In **Password** type your server administrator login password.</span></span>
   - <span data-ttu-id="e3b43-640">Zadejte nový název databáze, například: *MVC4SampleDB*.</span><span class="sxs-lookup"><span data-stu-id="e3b43-640">Type a new database name, for example: *MVC4SampleDB*.</span></span>

     <span data-ttu-id="e3b43-641">![Konfigurace cílový připojovací řetězec](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image80.png "konfigurace cílový připojovací řetězec")</span><span class="sxs-lookup"><span data-stu-id="e3b43-641">![Configuring destination connection string](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image80.png "Configuring destination connection string")</span></span>

     <span data-ttu-id="e3b43-642">*Konfigurace cílový připojovací řetězec*</span><span class="sxs-lookup"><span data-stu-id="e3b43-642">*Configuring destination connection string*</span></span>
6. <span data-ttu-id="e3b43-643">Pak klikněte na tlačítko **OK**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-643">Then click **OK**.</span></span> <span data-ttu-id="e3b43-644">Po zobrazení výzvy k vytvoření databáze klikněte na **Ano**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-644">When prompted to create the database click **Yes**.</span></span>

    <span data-ttu-id="e3b43-645">![Vytvoření databáze](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image81.png "vytvoření řetězce databáze")</span><span class="sxs-lookup"><span data-stu-id="e3b43-645">![Creating the database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image81.png "Creating the database string")</span></span>

    <span data-ttu-id="e3b43-646">*Vytvoření databáze*</span><span class="sxs-lookup"><span data-stu-id="e3b43-646">*Creating the database*</span></span>
7. <span data-ttu-id="e3b43-647">Připojovací řetězec, který budete používat pro připojení k databázi SQL ve službě Windows Azure se zobrazí v textovém poli výchozí připojení.</span><span class="sxs-lookup"><span data-stu-id="e3b43-647">The connection string you will use to connect to SQL Database in Windows Azure is shown within Default Connection textbox.</span></span> <span data-ttu-id="e3b43-648">Pak klikněte na tlačítko **Další**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-648">Then click **Next**.</span></span>

    <span data-ttu-id="e3b43-649">![Připojovací řetězec odkazující na SQL Database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image82.png "připojovací řetězec odkazující na SQL Database")</span><span class="sxs-lookup"><span data-stu-id="e3b43-649">![Connection string pointing to SQL Database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image82.png "Connection string pointing to SQL Database")</span></span>

    <span data-ttu-id="e3b43-650">*Připojovací řetězec odkazující na SQL Database*</span><span class="sxs-lookup"><span data-stu-id="e3b43-650">*Connection string pointing to SQL Database*</span></span>
8. <span data-ttu-id="e3b43-651">V **ve verzi Preview** klikněte na **publikovat**.</span><span class="sxs-lookup"><span data-stu-id="e3b43-651">In the **Preview** page, click **Publish**.</span></span>

    <span data-ttu-id="e3b43-652">![Publikování webové aplikace](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image83.png "publikování webové aplikace")</span><span class="sxs-lookup"><span data-stu-id="e3b43-652">![Publishing the web application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image83.png "Publishing the web application")</span></span>

    <span data-ttu-id="e3b43-653">*Publikování webové aplikace*</span><span class="sxs-lookup"><span data-stu-id="e3b43-653">*Publishing the web application*</span></span>
9. <span data-ttu-id="e3b43-654">Až se proces publikování dokončí, otevře se váš výchozí prohlížeč publikovaného webu.</span><span class="sxs-lookup"><span data-stu-id="e3b43-654">Once the publishing process finishes, your default browser will open the published web site.</span></span>

    <span data-ttu-id="e3b43-655">![Publikování aplikace do Windows Azure](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image84.png "publikování aplikace do Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="e3b43-655">![Application published to Windows Azure](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image84.png "Application published to Windows Azure")</span></span>

    <span data-ttu-id="e3b43-656">*Aplikace publikovaná do Windows Azure*</span><span class="sxs-lookup"><span data-stu-id="e3b43-656">*Application published to Windows Azure*</span></span>
