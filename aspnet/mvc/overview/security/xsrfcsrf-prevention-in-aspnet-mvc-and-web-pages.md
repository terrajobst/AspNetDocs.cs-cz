...
- Token zabezpečení skládající se z náhodných identifikátor 128 bitů.   
 Token pro ověření relace XSRF žádost zobrazit pomocí vývojářských nástrojů Internet Explorer F12 naleznete na následujícím obrázku: (Poznámka: Toto je aktuální implementace a podléhá, dokonce i pravděpodobně, chcete-li změnit.)
