...
Tato videa Prozkoumejte použití nástroje Page Inspector ve webových aplikacích ASP.NET MVC. [Přečtěte si kurz](../../overview/views/using-page-inspector-in-aspnet-mvc.md)

[&#9654;Sledovat video (6 minut)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/using-page-inspector-in-aspnet-mvc)
