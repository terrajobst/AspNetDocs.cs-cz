...
### <a name="exercise-1-using-aspnet-mvc-4-scaffolding-with-entity-framework-migrations"></a>Cvičení 1: Migrace rozhraní Entity Framework pomocí generování uživatelského rozhraní ASP.NET MVC 4
...
10. Klikněte na **Přidat**. Vyberte hodnoty **přepsat PersonController.cs** a **přepsat přidružené zobrazení** a klikněte na tlačítko **OK**.
