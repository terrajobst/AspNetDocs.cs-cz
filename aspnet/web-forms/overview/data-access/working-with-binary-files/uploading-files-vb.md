...
[![Add uživatelského ovládacího prvku SectionLevelTutorialListing.ascx Default.aspx](uploading-files-vb/_static/image2.gif)](uploading-files-vb/_static/image1.png)
...
[![Binary Data mohou být uloženy v systému souborů nebo přímo v databází](uploading-files-vb/_static/image4.gif)](uploading-files-vb/_static/image3.png)
...
[![Add BrochurePath sloupce do tabulky Kategorie](uploading-files-vb/_static/image5.gif)](uploading-files-vb/_static/image5.png)
...
[![Cvytvořit objekt DataColumn obrázek s názvem jehož datový typ je System.Byte []](uploading-files-vb/_static/image6.gif)](uploading-files-vb/_static/image7.png)
...
[![UAktualizovat seznam sloupců v příkazu SELECT na také vrátit BrochurePath](uploading-files-vb/_static/image7.gif)](uploading-files-vb/_static/image9.png)
...
[![SPoužít SQL příkazy možnost rozhodnout, jestli](uploading-files-vb/_static/image8.gif)](uploading-files-vb/_static/image11.png)
...
[![Since dotaz vrátí záznam z tabulky kategorie, zvolte možnost vybrat, na které vrátí řádky](uploading-files-vb/_static/image9.gif)](uploading-files-vb/_static/image13.png)
...
[![CZvolte názvy pro TableAdapter s metody](uploading-files-vb/_static/image10.gif)](uploading-files-vb/_static/image15.png)
...
[![Add FileUpload ovládacího prvku pro stránku ASP.NET](uploading-files-vb/_static/image12.gif)](uploading-files-vb/_static/image17.png)
...
[![Tz počítače na server mohl uživatel můžete vybrat soubor k nahrání](uploading-files-vb/_static/image13.gif)](uploading-files-vb/_static/image19.png)
...
[![Tmá soubor EvolutionValley.jpg byl odeslán na webový server](uploading-files-vb/_static/image14.gif)](uploading-files-vb/_static/image21.png)
