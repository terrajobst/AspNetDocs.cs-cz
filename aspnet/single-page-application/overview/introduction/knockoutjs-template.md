...
- `TodoController`: Zpracuje požadavky HTTP pro položky úkolů
- `TodoListController`: Zpracuje požadavky HTTP pro seznamy úkolů.
...
- **Hodnota**: Použít k naplnění hodnot formuláře.
- **Klikněte na tlačítko**: Vytvoří vazbu událost click k funkci v modelu zobrazení.
