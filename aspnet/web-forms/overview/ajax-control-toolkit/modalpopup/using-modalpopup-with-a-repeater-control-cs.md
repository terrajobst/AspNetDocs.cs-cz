...
[Stažení kódu](https://download.microsoft.com/download/2/4/0/24052038-f942-4336-905b-b60ae56f0dd5/ModalPopup2.cs.zip) nebo [stažení PDF](https://download.microsoft.com/download/b/6/a/b6ae89ee-df69-4c87-9bfb-ad1eb2b23373/modalpopup2CS.pdf)
...
[![modální překryvné okno lze aktivovat pro každou položku zdroje dat.](using-modalpopup-with-a-repeater-control-cs/_static/image2.png)](using-modalpopup-with-a-repeater-control-cs/_static/image1.png)

Modální překryvné okno lze aktivovat pro každou položku zdroje dat ([kliknutím zobrazíte obrázek v plné velikosti).](using-modalpopup-with-a-repeater-control-cs/_static/image3.png)
