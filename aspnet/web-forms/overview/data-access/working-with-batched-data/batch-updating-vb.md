...
[![EACH řádku v prvku GridView je upravit](batch-updating-vb/_static/image1.gif)](batch-updating-vb/_static/image1.png)
...
[![Configurovat ObjectDataSource pomocí třídy ProductsBLL](batch-updating-vb/_static/image2.gif)](batch-updating-vb/_static/image3.png)
...
[![Rnačíst Data produktů pomocí metody GetProducts](batch-updating-vb/_static/image3.gif)](batch-updating-vb/_static/image5.png)
...
[![Set rozevírací seznamy v UPDATE, INSERT a DELETE karty na (žádný)](batch-updating-vb/_static/image4.gif)](batch-updating-vb/_static/image7.png)
...
## <a name="step-2-creating-theproductnameunitprice-anddiscontinuedediting-interfaces"></a>Krok 2: Vytváří`ProductName`,`UnitPrice`, a`Discontinued`úpravy rozhraní
...
[![Tmá ProductName TemplateField teď obsahuje textové pole a RequiredFieldValidator](batch-updating-vb/_static/image6.gif)](batch-updating-vb/_static/image9.png)
...
[![Add CompareValidator zajistit Zadaná cena je nezáporná hodnota měny](batch-updating-vb/_static/image7.gif)](batch-updating-vb/_static/image11.png)
...
## <a name="step-3-creating-thecategorynameediting-interface"></a>Krok 3: Vytváří`CategoryName`úpravy rozhraní
...
[![Configurovat ObjectDataSource pomocí třídy CategoriesBLL](batch-updating-vb/_static/image8.gif)](batch-updating-vb/_static/image13.png)
...
[![RNačíst kategorie dat pomocí metody GetCategories](batch-updating-vb/_static/image9.gif)](batch-updating-vb/_static/image15.png)
...
[![Set rozevírací seznamy v aktualizaci a odstranění karty na (žádný)](batch-updating-vb/_static/image10.gif)](batch-updating-vb/_static/image17.png)
...
[![BIND DropDownList k CategoriesDataSource](batch-updating-vb/_static/image11.gif)](batch-updating-vb/_static/image19.png)
...
[![EACH řádky GridView je upravit](batch-updating-vb/_static/image13.gif)](batch-updating-vb/_static/image21.png)
...
[![Tmá stránka nyní obsahuje dvě aktualizace produktů tlačítka](batch-updating-vb/_static/image16.gif)](batch-updating-vb/_static/image23.png)
