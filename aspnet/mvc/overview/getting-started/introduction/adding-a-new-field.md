...
Dále otevřete *\Views\Movies\Create.cshtml* a přidejte `Rating` pole s následující zvýrazněný kód. Tím zkopírujete textové pole tak, aby hodnocení můžete zadat, když se vytvoří nová videa.
