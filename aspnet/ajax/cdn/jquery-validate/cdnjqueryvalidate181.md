...
ms.locfileid: "59410783"
---
# <a name="jqueryvalidate-version-181"></a><span data-ttu-id="82892-102">jquery.validate verze 1.8.1</span><span class="sxs-lookup"><span data-stu-id="82892-102">jquery.validate version 1.8.1</span></span>

<span data-ttu-id="82892-103">Následující soubory jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="82892-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="82892-104">Lokalizace souborů na https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js kde ## je lokalizace kódu.</span><span class="sxs-lookup"><span data-stu-id="82892-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
