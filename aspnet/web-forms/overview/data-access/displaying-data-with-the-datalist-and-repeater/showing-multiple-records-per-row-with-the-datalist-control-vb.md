...
[![Tmá DataList ukazuje tři produkty na každém řádku](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image2.png)](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image1.png)
...
[![BVýchozí y, vykreslení ovládacích prvků DataList jako tabulka jedním sloupcem, více řádky](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image5.png)](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image4.png)
...
[![Tmá RepeatDirection vlastnost určuje, jak the směr DataList s položek jsou podle Out](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image8.png)](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image7.png)
...
[![Fnebo dostatečně velké datové zdroje, a jeden sloupec v prvku DataList bude vyžadovat vodorovného posouvání](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image11.png)](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image10.png)
...
[![Ttři produkty jsou zobrazeny na každém řádku](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image14.png)](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image13.png)
...
[![Here tyto produkty jsou stanoveny na svisle](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image17.png)](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image16.png)
