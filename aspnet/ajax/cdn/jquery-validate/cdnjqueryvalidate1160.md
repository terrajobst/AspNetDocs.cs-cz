...
ms.locfileid: "57066310"
---
<a name="jquery-validation-1160"></a><span data-ttu-id="af68a-102">jQuery Validation 1.16.0</span><span class="sxs-lookup"><span data-stu-id="af68a-102">jQuery Validation 1.16.0</span></span>
====================
<span data-ttu-id="af68a-103">Následující soubory jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="af68a-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="af68a-104">Lokalizace souborů na https://ajax.aspnetcdn.com/ajax/jquery.validate/1.16.0/localization/messages\_##.js kde ## je lokalizace kódu.</span><span class="sxs-lookup"><span data-stu-id="af68a-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.16.0/localization/messages\_##.js where ## is the loc code.</span></span>
