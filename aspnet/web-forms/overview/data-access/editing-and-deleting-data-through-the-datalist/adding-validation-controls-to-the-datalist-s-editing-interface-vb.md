...
## <a name="step-1-replicating-the-example-fromhandling-bll--and-dal-level-exceptions"></a>Krok 1: replikace příkladu z manipulace s[výjimkami na úrovni knihoven BLL a dal](handling-bll-and-dal-level-exceptions-vb.md)
