...
<span data-ttu-id="b95a3-158">V této úloze vytvoříte třídy kontroleru, ve kterých se bude nacházet metody rozhraní API.</span><span class="sxs-lookup"><span data-stu-id="b95a3-158">In this task, you will create the controller classes in which API methods will reside.</span></span>
...
5. <span data-ttu-id="b95a3-170">Stisknutím klávesy **F5** k ladění aplikace.</span><span class="sxs-lookup"><span data-stu-id="b95a3-170">Press **F5** to debug the application.</span></span> <span data-ttu-id="b95a3-171">By se zobrazit výchozí domovskou stránku projektu webového rozhraní API.</span><span class="sxs-lookup"><span data-stu-id="b95a3-171">The default home page for a Web API project should appear.</span></span>
    ...
    <span data-ttu-id="b95a3-173">*Výchozí domovskou stránku aplikace ASP.NET Web API*</span><span class="sxs-lookup"><span data-stu-id="b95a3-173">*The default home page of an ASP.NET Web API application*</span></span>
...
2. <span data-ttu-id="b95a3-198">V **přidat novou položku** dialogového okna, název nového souboru **Contact.cs** a klikněte na tlačítko **přidat.**</span><span class="sxs-lookup"><span data-stu-id="b95a3-198">In the **Add New Item** dialog, name the new file **Contact.cs** and click **Add.**</span></span>
    ...
    <span data-ttu-id="b95a3-200">*Vytváří se nový soubor třídy kontaktu*</span><span class="sxs-lookup"><span data-stu-id="b95a3-200">*Creating the new Contact class file*</span></span>
...
3. <span data-ttu-id="b95a3-281">Upravte kód **GetAllContacts** způsob, jak je znázorněno níže.</span><span class="sxs-lookup"><span data-stu-id="b95a3-281">Modify the code for the **GetAllContacts** method as demonstrated below.</span></span>
    ...
    <span data-ttu-id="b95a3-282">(Fragment - kódu *webové rozhraní API Lab – Ex02 - Get All Contacts*)</span><span class="sxs-lookup"><span data-stu-id="b95a3-282">(Code Snippet - *Web API Lab - Ex02 - Get All Contacts*)</span></span>
...
<span data-ttu-id="b95a3-292">V této úloze budete upravovat výchozí Index zobrazení webové aplikaci, aby podporovala požadavky na zobrazení seznamu existující kontaktů v prohlížeče HTML.</span><span class="sxs-lookup"><span data-stu-id="b95a3-292">In this task, you will modify the default Index view of the web application to support the requirement of displaying the list of existing contacts in an HTML browser.</span></span>
...
10. <span data-ttu-id="b95a3-316">Odebrat zarážku a stisknutím klávesy **F5** nebo ladění nástrojů **pokračovat** tlačítka pokračovat v načítání zobrazení v prohlížeči.</span><span class="sxs-lookup"><span data-stu-id="b95a3-316">Remove the breakpoint and press **F5** or the debugging toolbar's **Continue** button to continue loading the view in the browser.</span></span> <span data-ttu-id="b95a3-317">Po dokončení volání webového rozhraní API byste měli vidět kontakty vrácená z webového rozhraní API volat jako seznam položek v prohlížeči.</span><span class="sxs-lookup"><span data-stu-id="b95a3-317">Once the Web API call completes you should see the contacts returned from the Web API call displayed as list items in the browser.</span></span>
    ...
    <span data-ttu-id="b95a3-319">*Výsledky volání rozhraní API, zobrazí v prohlížeči jako položky seznamu*</span><span class="sxs-lookup"><span data-stu-id="b95a3-319">*Results of the API call displayed in the browser as list items*</span></span>
...
5. <span data-ttu-id="b95a3-365">Stiskněte klávesu Tabulátor dvakrát pro vložení fragmentu do umístění kurzoru.</span><span class="sxs-lookup"><span data-stu-id="b95a3-365">Press the Tab key twice to insert the snippet at the cursor location.</span></span>
    ...
    <span data-ttu-id="b95a3-367">*Začněte psát název fragmentu kódu*</span><span class="sxs-lookup"><span data-stu-id="b95a3-367">*Start typing the snippet name*</span></span>
...
3. <span data-ttu-id="b95a3-375">Kliknutím na vyberte relevantní fragment kódu ze seznamu.</span><span class="sxs-lookup"><span data-stu-id="b95a3-375">Pick the relevant snippet from the list, by clicking on it.</span></span>
    ...
    <span data-ttu-id="b95a3-379">*Vyberte si relevantní fragment kódu ze seznamu, kliknutím na*</span><span class="sxs-lookup"><span data-stu-id="b95a3-379">*Pick the relevant snippet from the list, by clicking on it*</span></span>
...
2. <span data-ttu-id="b95a3-385">Klikněte na **nainstalovat**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-385">Click on **Install Now**.</span></span> <span data-ttu-id="b95a3-386">Pokud nemáte **instalačního programu webové platformy** budete přesměrováni na stáhněte a nainstalujte ji jako první.</span><span class="sxs-lookup"><span data-stu-id="b95a3-386">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="b95a3-387">Jednou **instalačního programu webové platformy** je otevřený, klikněte na tlačítko **nainstalovat** spustit instalační program.</span><span class="sxs-lookup"><span data-stu-id="b95a3-387">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="b95a3-388">![Instalace sady Visual Studio Express](build-restful-apis-with-aspnet-web-api/_static/image34.png "instalace sady Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="b95a3-388">![Install Visual Studio Express](build-restful-apis-with-aspnet-web-api/_static/image34.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="b95a3-389">*Instalace sady Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="b95a3-389">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="b95a3-390">Čtení všech produktů licence a podmínky a klikněte na tlačítko **souhlasím** pokračujte.</span><span class="sxs-lookup"><span data-stu-id="b95a3-390">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Přijetí podmínek licence](build-restful-apis-with-aspnet-web-api/_static/image35.png)

    <span data-ttu-id="b95a3-392">*Přijetí podmínek licence*</span><span class="sxs-lookup"><span data-stu-id="b95a3-392">*Accepting the license terms*</span></span>
5. <span data-ttu-id="b95a3-393">Počkejte na dokončení procesu stahování a instalaci.</span><span class="sxs-lookup"><span data-stu-id="b95a3-393">Wait until the downloading and installation process completes.</span></span>

    ![Průběh instalace](build-restful-apis-with-aspnet-web-api/_static/image36.png)

    <span data-ttu-id="b95a3-395">*Průběh instalace*</span><span class="sxs-lookup"><span data-stu-id="b95a3-395">*Installation progress*</span></span>
6. <span data-ttu-id="b95a3-396">Až instalace skončí, klikněte na tlačítko **Dokončit**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-396">When the installation completes, click **Finish**.</span></span>

    ![Instalace byla dokončena.](build-restful-apis-with-aspnet-web-api/_static/image37.png)

    <span data-ttu-id="b95a3-398">*Instalace byla dokončena.*</span><span class="sxs-lookup"><span data-stu-id="b95a3-398">*Installation completed*</span></span>
7. <span data-ttu-id="b95a3-399">Klikněte na tlačítko **ukončovací** zavřete instalačního programu webové platformy.</span><span class="sxs-lookup"><span data-stu-id="b95a3-399">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="b95a3-400">Chcete-li spustit nástroj Visual Studio Express for Web, přejděte **Start** obrazovky a začít psát &quot; **VS Express**&quot;, klikněte na **VS Express for Web** dlaždice.</span><span class="sxs-lookup"><span data-stu-id="b95a3-400">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express for Web dlaždice](build-restful-apis-with-aspnet-web-api/_static/image38.png)

    <span data-ttu-id="b95a3-402">*VS Express for Web dlaždice*</span><span class="sxs-lookup"><span data-stu-id="b95a3-402">*VS Express for Web tile*</span></span>

<a id="AppendixC"></a>

<a id="Appendix_C_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
## <a name="appendix-c-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="b95a3-403">Příloha C: Publikování aplikace ASP.NET MVC 4 pomocí nasazení webu</span><span class="sxs-lookup"><span data-stu-id="b95a3-403">Appendix C: Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

<span data-ttu-id="b95a3-404">Tento dodatek se ukazují, jak vytvořit nový web z portálu Azure Portal a publikovat aplikace, kterou jste získali podle testovacího prostředí, využít Webdeploy publikační funkci poskytovaný platformou Azure.</span><span class="sxs-lookup"><span data-stu-id="b95a3-404">This appendix will show you how to create a new web site from the Azure Portal and publish the application you obtained by following the lab, taking advantage of the Web Deploy publishing feature provided by Azure.</span></span>

<a id="ApxCTask1"></a>

<a id="Task_1_-_Creating_a_New_Web_Site_from_the_Windows_Azure_Portal"></a>
#### <a name="task-1---creating-a-new-web-site-from-the-azure-portal"></a><span data-ttu-id="b95a3-405">Úloha 1 – Vytvoření nového webu na webu Azure Portal</span><span class="sxs-lookup"><span data-stu-id="b95a3-405">Task 1 - Creating a New Web Site from the Azure Portal</span></span>

1. <span data-ttu-id="b95a3-406">Přejděte [portálu pro správu Azure](https://manage.windowsazure.com/) a přihlaste se pomocí přihlašovacích údajů Microsoft spojených s vaším předplatným.</span><span class="sxs-lookup"><span data-stu-id="b95a3-406">Go to the [Azure Management Portal](https://manage.windowsazure.com/) and sign in using the Microsoft credentials associated with your subscription.</span></span>

    > [!NOTE]
    > <span data-ttu-id="b95a3-407">S Azure můžete zadarmo hostovat 10 webů ASP.NET a pak škálujte podle rozšiřujícího se provozu.</span><span class="sxs-lookup"><span data-stu-id="b95a3-407">With Azure you can host 10 ASP.NET Web Sites for free and then scale as your traffic grows.</span></span> <span data-ttu-id="b95a3-408">Můžete se zaregistrovat [tady](https://aka.ms/aspnet-hol-azure).</span><span class="sxs-lookup"><span data-stu-id="b95a3-408">You can sign up [here](https://aka.ms/aspnet-hol-azure).</span></span>

    <span data-ttu-id="b95a3-409">![Přihlaste se k portálu Windows Azure](build-restful-apis-with-aspnet-web-api/_static/image39.png "Přihlaste se k portálu Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="b95a3-409">![Log on to Windows Azure portal](build-restful-apis-with-aspnet-web-api/_static/image39.png "Log on to Windows Azure portal")</span></span>

    <span data-ttu-id="b95a3-410">*Přihlaste se k portálu*</span><span class="sxs-lookup"><span data-stu-id="b95a3-410">*Log on to Portal*</span></span>
2. <span data-ttu-id="b95a3-411">Klikněte na tlačítko **nový** na panelu příkazů.</span><span class="sxs-lookup"><span data-stu-id="b95a3-411">Click **New** on the command bar.</span></span>

    <span data-ttu-id="b95a3-412">![Vytvoření nového webu](build-restful-apis-with-aspnet-web-api/_static/image40.png "vytváření nového webu")</span><span class="sxs-lookup"><span data-stu-id="b95a3-412">![Creating a new Web Site](build-restful-apis-with-aspnet-web-api/_static/image40.png "Creating a new Web Site")</span></span>

    <span data-ttu-id="b95a3-413">*Vytvoření nového webu*</span><span class="sxs-lookup"><span data-stu-id="b95a3-413">*Creating a new Web Site*</span></span>
3. <span data-ttu-id="b95a3-414">Klikněte na tlačítko **Compute** | **webu**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-414">Click **Compute** | **Web Site**.</span></span> <span data-ttu-id="b95a3-415">Potom vyberte **rychlé vytvoření** možnost.</span><span class="sxs-lookup"><span data-stu-id="b95a3-415">Then select **Quick Create** option.</span></span> <span data-ttu-id="b95a3-416">Zadejte adresu URL k dispozici pro nový web a klikněte na tlačítko **vytvořit web**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-416">Provide an available URL for the new web site and click **Create Web Site**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="b95a3-417">Azure je hostitel pro webovou aplikaci spuštěnou v cloudu, který může řídit a spravovat.</span><span class="sxs-lookup"><span data-stu-id="b95a3-417">Azure is the host for a web application running in the cloud that you can control and manage.</span></span> <span data-ttu-id="b95a3-418">Možnost rychle vytvořit můžete nasadit hotové webové aplikace do Azure z mimo portál.</span><span class="sxs-lookup"><span data-stu-id="b95a3-418">The Quick Create option allows you to deploy a completed web application to the Azure from outside the portal.</span></span> <span data-ttu-id="b95a3-419">Nezahrnuje kroky pro vytvoření databáze.</span><span class="sxs-lookup"><span data-stu-id="b95a3-419">It does not include steps for setting up a database.</span></span>

    <span data-ttu-id="b95a3-420">![Vytvoření nového webu pomocí metody rychlého vytvoření](build-restful-apis-with-aspnet-web-api/_static/image41.png "vytváření nového webu pomocí metody rychlého vytvoření")</span><span class="sxs-lookup"><span data-stu-id="b95a3-420">![Creating a new Web Site using Quick Create](build-restful-apis-with-aspnet-web-api/_static/image41.png "Creating a new Web Site using Quick Create")</span></span>

    <span data-ttu-id="b95a3-421">*Vytvoření nového webu pomocí metody rychlého vytvoření*</span><span class="sxs-lookup"><span data-stu-id="b95a3-421">*Creating a new Web Site using Quick Create*</span></span>
4. <span data-ttu-id="b95a3-422">Počkejte, dokud nové **webu** se vytvoří.</span><span class="sxs-lookup"><span data-stu-id="b95a3-422">Wait until the new **Web Site** is created.</span></span>
5. <span data-ttu-id="b95a3-423">Po vytvoření webové stránky, klikněte na odkaz v části **URL** sloupce.</span><span class="sxs-lookup"><span data-stu-id="b95a3-423">Once the Web Site is created click the link under the **URL** column.</span></span> <span data-ttu-id="b95a3-424">Zkontrolujte, jestli funguje nový web.</span><span class="sxs-lookup"><span data-stu-id="b95a3-424">Check that the new Web Site is working.</span></span>

    <span data-ttu-id="b95a3-425">![Na nový web](build-restful-apis-with-aspnet-web-api/_static/image42.png "přechodu na nový web")</span><span class="sxs-lookup"><span data-stu-id="b95a3-425">![Browsing to the new web site](build-restful-apis-with-aspnet-web-api/_static/image42.png "Browsing to the new web site")</span></span>

    <span data-ttu-id="b95a3-426">*Procházení na nový web*</span><span class="sxs-lookup"><span data-stu-id="b95a3-426">*Browsing to the new web site*</span></span>

    <span data-ttu-id="b95a3-427">![Spuštění webu](build-restful-apis-with-aspnet-web-api/_static/image43.png "spuštění webové stránky")</span><span class="sxs-lookup"><span data-stu-id="b95a3-427">![Web site running](build-restful-apis-with-aspnet-web-api/_static/image43.png "Web site running")</span></span>

    <span data-ttu-id="b95a3-428">*Spuštění webové stránky*</span><span class="sxs-lookup"><span data-stu-id="b95a3-428">*Web site running*</span></span>
6. <span data-ttu-id="b95a3-429">Přejděte zpět na portál a klikněte na název webové stránky v části **název** sloupec, který se zobrazí na stránkách správy.</span><span class="sxs-lookup"><span data-stu-id="b95a3-429">Go back to the portal and click the name of the web site under the **Name** column to display the management pages.</span></span>

    <span data-ttu-id="b95a3-430">![Otevřete správu webových stránek](build-restful-apis-with-aspnet-web-api/_static/image44.png "otevřete správu webových stránek")</span><span class="sxs-lookup"><span data-stu-id="b95a3-430">![Opening the web site management pages](build-restful-apis-with-aspnet-web-api/_static/image44.png "Opening the web site management pages")</span></span>

    <span data-ttu-id="b95a3-431">*Otevřete správu webových stránek*</span><span class="sxs-lookup"><span data-stu-id="b95a3-431">*Opening the Web Site management pages*</span></span>
7. <span data-ttu-id="b95a3-432">V **řídicí panel** stránce v části **rychlý přehled** klikněte na tlačítko **stáhnout profil publikování** odkaz.</span><span class="sxs-lookup"><span data-stu-id="b95a3-432">In the **Dashboard** page, under the **quick glance** section, click the **Download publish profile** link.</span></span>

    > [!NOTE]
    > <span data-ttu-id="b95a3-433">*Profil publikování* obsahuje všechny informace požadované pro publikování webových aplikací do Azure pro každou metodu povoleno publikování.</span><span class="sxs-lookup"><span data-stu-id="b95a3-433">The *publish profile* contains all of the information required to publish a web application to a Azure for each enabled publication method.</span></span> <span data-ttu-id="b95a3-434">Profil publikování obsahuje adresy URL, přihlašovací údaje uživatele a databázové řetězce požadované k připojení a ověřování na základě jednotlivých koncových bodů, u kterých je povolena metoda publikace.</span><span class="sxs-lookup"><span data-stu-id="b95a3-434">The publish profile contains the URLs, user credentials and database strings required to connect to and authenticate against each of the endpoints for which a publication method is enabled.</span></span> <span data-ttu-id="b95a3-435">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** a **Microsoft Visual Studio 2012** podporují čtení publikační profily k automatizaci konfigurace z těchto programů pro publikování webových aplikací do Azure.</span><span class="sxs-lookup"><span data-stu-id="b95a3-435">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** and **Microsoft Visual Studio 2012** support reading publish profiles to automate configuration of these programs for publishing web applications to Azure.</span></span>

    <span data-ttu-id="b95a3-436">![Stahování webové stránky publikovat profil](build-restful-apis-with-aspnet-web-api/_static/image45.png "stahování webové stránky profil publikování")</span><span class="sxs-lookup"><span data-stu-id="b95a3-436">![Downloading the web site publish profile](build-restful-apis-with-aspnet-web-api/_static/image45.png "Downloading the web site publish profile")</span></span>

    <span data-ttu-id="b95a3-437">*Na webu stažení profilu publikování*</span><span class="sxs-lookup"><span data-stu-id="b95a3-437">*Downloading the Web Site publish profile*</span></span>
8. <span data-ttu-id="b95a3-438">Stáhněte si soubor profilu publikování do vhodného umístění.</span><span class="sxs-lookup"><span data-stu-id="b95a3-438">Download the publish profile file to a known location.</span></span> <span data-ttu-id="b95a3-439">Dále v tomto cvičení uvidíte jak publikovat webovou aplikaci do Azure ze sady Visual Studio pomocí tohoto souboru.</span><span class="sxs-lookup"><span data-stu-id="b95a3-439">Further in this exercise you will see how to use this file to publish a web application to Azure from Visual Studio.</span></span>

    <span data-ttu-id="b95a3-440">![Ukládání souboru profilu publikování](build-restful-apis-with-aspnet-web-api/_static/image46.png "ukládá se profil publikování")</span><span class="sxs-lookup"><span data-stu-id="b95a3-440">![Saving the publish profile file](build-restful-apis-with-aspnet-web-api/_static/image46.png "Saving the publish profile")</span></span>

    <span data-ttu-id="b95a3-441">*Ukládá se profil publikování*</span><span class="sxs-lookup"><span data-stu-id="b95a3-441">*Saving the publish profile file*</span></span>

<a id="ApxCTask2"></a>

<a id="Task_2_-_Configuring_the_Database_Server"></a>
#### <a name="task-2---configuring-the-database-server"></a><span data-ttu-id="b95a3-442">Úloha 2 – konfigurování serveru databáze</span><span class="sxs-lookup"><span data-stu-id="b95a3-442">Task 2 - Configuring the Database Server</span></span>

<span data-ttu-id="b95a3-443">Pokud vaše aplikace využívá SQL Server databáze, budete muset vytvořit server služby SQL Database.</span><span class="sxs-lookup"><span data-stu-id="b95a3-443">If your application makes use of SQL Server databases you will need to create a SQL Database server.</span></span> <span data-ttu-id="b95a3-444">Pokud chcete nasadit jednoduchou aplikaci, která nepoužívá SQL Server může tuto úlohu přeskočit.</span><span class="sxs-lookup"><span data-stu-id="b95a3-444">If you want to deploy a simple application that does not use SQL Server you might skip this task.</span></span>

1. <span data-ttu-id="b95a3-445">Pro uložení databáze aplikace budete potřebovat databázi SQL serveru.</span><span class="sxs-lookup"><span data-stu-id="b95a3-445">You will need a SQL Database server for storing the application database.</span></span> <span data-ttu-id="b95a3-446">Servery SQL Database můžete zobrazit ze svého předplatného na portálu Azure Management portal na **databází Sql** | **servery** | **řídicího panelu serveru**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-446">You can view the SQL Database servers from your subscription in the Azure Management portal at **Sql Databases** | **Servers** | **Server's Dashboard**.</span></span> <span data-ttu-id="b95a3-447">Pokud nemáte server vytvořili, můžete vytvořit jednu **přidat** tlačítko na panelu příkazů.</span><span class="sxs-lookup"><span data-stu-id="b95a3-447">If you do not have a server created, you can create one using the **Add** button on the command bar.</span></span> <span data-ttu-id="b95a3-448">Poznamenejte si **název serveru a adresu URL, správce přihlašovací jméno a heslo**, jak je použijete v další úkoly.</span><span class="sxs-lookup"><span data-stu-id="b95a3-448">Take note of the **server name and URL, administrator login name and password**, as you will use them in the next tasks.</span></span> <span data-ttu-id="b95a3-449">Nevytvářet databáze, protože vytvoří se v pozdější fázi.</span><span class="sxs-lookup"><span data-stu-id="b95a3-449">Do not create the database yet, as it will be created in a later stage.</span></span>

    <span data-ttu-id="b95a3-450">![Řídicí panel serveru SQL Database](build-restful-apis-with-aspnet-web-api/_static/image47.png "řídicího panelu serveru SQL Database")</span><span class="sxs-lookup"><span data-stu-id="b95a3-450">![SQL Database Server Dashboard](build-restful-apis-with-aspnet-web-api/_static/image47.png "SQL Database Server Dashboard")</span></span>

    <span data-ttu-id="b95a3-451">*Řídicí panel serveru SQL Database*</span><span class="sxs-lookup"><span data-stu-id="b95a3-451">*SQL Database Server Dashboard*</span></span>
2. <span data-ttu-id="b95a3-452">V dalším úkolem budete testovat připojení k databázi ze sady Visual Studio z tohoto důvodu je nutné zahrnout místní IP adresa serveru seznamu **povolené IP adresy**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-452">In the next task you will test the database connection from Visual Studio, for that reason you need to include your local IP address in the server's list of **Allowed IP Addresses**.</span></span> <span data-ttu-id="b95a3-453">Chcete-li to mohli udělat, klikněte na tlačítko **konfigurovat**, vyberte IP adresu z **aktuální IP adresa klienta** a vložte ho na **počáteční IP adresa** a **Koncová IP adresa** textová pole a klikněte na tlačítko ![add-client-ip-address-ok-button](build-restful-apis-with-aspnet-web-api/_static/image48.png) tlačítko.</span><span class="sxs-lookup"><span data-stu-id="b95a3-453">To do that, click **Configure**, select the IP address from **Current Client IP Address** and paste it on the **Start IP Address** and **End IP Address** text boxes and click the ![add-client-ip-address-ok-button](build-restful-apis-with-aspnet-web-api/_static/image48.png) button.</span></span>

    ![Přidat IP adresu klienta](build-restful-apis-with-aspnet-web-api/_static/image49.png)

    <span data-ttu-id="b95a3-455">*Přidat IP adresu klienta*</span><span class="sxs-lookup"><span data-stu-id="b95a3-455">*Adding Client IP Address*</span></span>
3. <span data-ttu-id="b95a3-456">Jednou **IP adresa klienta** je přidat do povolených IP adres klikněte na tlačítko na **Uložit** potvrďte provedené změny.</span><span class="sxs-lookup"><span data-stu-id="b95a3-456">Once the **Client IP Address** is added to the allowed IP addresses list, click on **Save** to confirm the changes.</span></span>

    ![Potvrzení změn](build-restful-apis-with-aspnet-web-api/_static/image50.png)

    <span data-ttu-id="b95a3-458">*Potvrzení změn*</span><span class="sxs-lookup"><span data-stu-id="b95a3-458">*Confirm Changes*</span></span>

<a id="ApxCTask3"></a>

<a id="Task_3_-_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
#### <a name="task-3---publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="b95a3-459">Úloha 3 – publikování aplikace ASP.NET MVC 4 pomocí nasazení webu</span><span class="sxs-lookup"><span data-stu-id="b95a3-459">Task 3 - Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

1. <span data-ttu-id="b95a3-460">Vraťte se do řešení ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="b95a3-460">Go back to the ASP.NET MVC 4 solution.</span></span> <span data-ttu-id="b95a3-461">V **Průzkumníka řešení**, klikněte pravým tlačítkem na webový projekt a vyberte **publikovat**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-461">In the **Solution Explorer**, right-click the web site project and select **Publish**.</span></span>

    <span data-ttu-id="b95a3-462">![Publikování aplikace](build-restful-apis-with-aspnet-web-api/_static/image51.png "publikování aplikace")</span><span class="sxs-lookup"><span data-stu-id="b95a3-462">![Publishing the Application](build-restful-apis-with-aspnet-web-api/_static/image51.png "Publishing the Application")</span></span>

    <span data-ttu-id="b95a3-463">*Publikování na webu*</span><span class="sxs-lookup"><span data-stu-id="b95a3-463">*Publishing the web site*</span></span>
2. <span data-ttu-id="b95a3-464">Importujte profil publikování, který jste uložili v první úloze.</span><span class="sxs-lookup"><span data-stu-id="b95a3-464">Import the publish profile you saved in the first task.</span></span>

    <span data-ttu-id="b95a3-465">![Import profilu publikování](build-restful-apis-with-aspnet-web-api/_static/image52.png "import profilu publikování")</span><span class="sxs-lookup"><span data-stu-id="b95a3-465">![Importing the publish profile](build-restful-apis-with-aspnet-web-api/_static/image52.png "Importing the publish profile")</span></span>

    <span data-ttu-id="b95a3-466">*Import publikačního profilu*</span><span class="sxs-lookup"><span data-stu-id="b95a3-466">*Importing publish profile*</span></span>
3. <span data-ttu-id="b95a3-467">Klikněte na tlačítko **ověřit připojení**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-467">Click **Validate Connection**.</span></span> <span data-ttu-id="b95a3-468">Po dokončení ověření klikněte na tlačítko **Další**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-468">Once Validation is complete click **Next**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="b95a3-469">Ověření bylo dokončeno, jakmile se zobrazí zelené zaškrtnutí vedle tlačítka ověřit připojení.</span><span class="sxs-lookup"><span data-stu-id="b95a3-469">Validation is complete once you see a green checkmark appear next to the Validate Connection button.</span></span>

    <span data-ttu-id="b95a3-470">![Ověřuje se připojení](build-restful-apis-with-aspnet-web-api/_static/image53.png "ověřuje se připojení")</span><span class="sxs-lookup"><span data-stu-id="b95a3-470">![Validating connection](build-restful-apis-with-aspnet-web-api/_static/image53.png "Validating connection")</span></span>

    <span data-ttu-id="b95a3-471">*Ověřuje se připojení*</span><span class="sxs-lookup"><span data-stu-id="b95a3-471">*Validating connection*</span></span>
4. <span data-ttu-id="b95a3-472">V **nastavení** stránce v části **databází** klikněte na tlačítko vedle textového pole připojení k databázi (to znamená **objekt DefaultConnection**).</span><span class="sxs-lookup"><span data-stu-id="b95a3-472">In the **Settings** page, under the **Databases** section, click the button next to your database connection's textbox (i.e. **DefaultConnection**).</span></span>

    <span data-ttu-id="b95a3-473">![Konfigurace nasazení webu](build-restful-apis-with-aspnet-web-api/_static/image54.png "konfigurace nasazení webu")</span><span class="sxs-lookup"><span data-stu-id="b95a3-473">![Web deploy configuration](build-restful-apis-with-aspnet-web-api/_static/image54.png "Web deploy configuration")</span></span>

    <span data-ttu-id="b95a3-474">*Konfigurace nasazení webu*</span><span class="sxs-lookup"><span data-stu-id="b95a3-474">*Web deploy configuration*</span></span>
5. <span data-ttu-id="b95a3-475">Konfigurace připojení k databázi následujícím způsobem:</span><span class="sxs-lookup"><span data-stu-id="b95a3-475">Configure the database connection as follows:</span></span>

   - <span data-ttu-id="b95a3-476">V **název serveru** zadejte vaše pomocí adresy URL databáze SQL serveru *tcp:* předponu.</span><span class="sxs-lookup"><span data-stu-id="b95a3-476">In the **Server name** type your SQL Database server URL using the *tcp:* prefix.</span></span>
   - <span data-ttu-id="b95a3-477">V **uživatelské jméno** zadejte vaše přihlašovací jméno správce serveru.</span><span class="sxs-lookup"><span data-stu-id="b95a3-477">In **User name** type your server administrator login name.</span></span>
   - <span data-ttu-id="b95a3-478">V **heslo** zadejte heslo pro přihlašovací jméno správce serveru.</span><span class="sxs-lookup"><span data-stu-id="b95a3-478">In **Password** type your server administrator login password.</span></span>
   - <span data-ttu-id="b95a3-479">Zadejte nový název databáze, například: *MVC4SampleDB*.</span><span class="sxs-lookup"><span data-stu-id="b95a3-479">Type a new database name, for example: *MVC4SampleDB*.</span></span>

     <span data-ttu-id="b95a3-480">![Konfigurace cílový připojovací řetězec](build-restful-apis-with-aspnet-web-api/_static/image55.png "konfigurace cílový připojovací řetězec")</span><span class="sxs-lookup"><span data-stu-id="b95a3-480">![Configuring destination connection string](build-restful-apis-with-aspnet-web-api/_static/image55.png "Configuring destination connection string")</span></span>

     <span data-ttu-id="b95a3-481">*Konfigurace cílový připojovací řetězec*</span><span class="sxs-lookup"><span data-stu-id="b95a3-481">*Configuring destination connection string*</span></span>
6. <span data-ttu-id="b95a3-482">Pak klikněte na tlačítko **OK**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-482">Then click **OK**.</span></span> <span data-ttu-id="b95a3-483">Po zobrazení výzvy k vytvoření databáze klikněte na **Ano**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-483">When prompted to create the database click **Yes**.</span></span>

    <span data-ttu-id="b95a3-484">![Vytvoření databáze](build-restful-apis-with-aspnet-web-api/_static/image56.png "vytvoření řetězce databáze")</span><span class="sxs-lookup"><span data-stu-id="b95a3-484">![Creating the database](build-restful-apis-with-aspnet-web-api/_static/image56.png "Creating the database string")</span></span>

    <span data-ttu-id="b95a3-485">*Vytvoření databáze*</span><span class="sxs-lookup"><span data-stu-id="b95a3-485">*Creating the database*</span></span>
7. <span data-ttu-id="b95a3-486">Připojovací řetězec, který budete používat pro připojení k databázi SQL ve službě Windows Azure se zobrazí v textovém poli výchozí připojení.</span><span class="sxs-lookup"><span data-stu-id="b95a3-486">The connection string you will use to connect to SQL Database in Windows Azure is shown within Default Connection textbox.</span></span> <span data-ttu-id="b95a3-487">Pak klikněte na tlačítko **Další**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-487">Then click **Next**.</span></span>

    <span data-ttu-id="b95a3-488">![Připojovací řetězec odkazující na SQL Database](build-restful-apis-with-aspnet-web-api/_static/image57.png "připojovací řetězec odkazující na SQL Database")</span><span class="sxs-lookup"><span data-stu-id="b95a3-488">![Connection string pointing to SQL Database](build-restful-apis-with-aspnet-web-api/_static/image57.png "Connection string pointing to SQL Database")</span></span>

    <span data-ttu-id="b95a3-489">*Připojovací řetězec odkazující na SQL Database*</span><span class="sxs-lookup"><span data-stu-id="b95a3-489">*Connection string pointing to SQL Database*</span></span>
8. <span data-ttu-id="b95a3-490">V **ve verzi Preview** klikněte na **publikovat**.</span><span class="sxs-lookup"><span data-stu-id="b95a3-490">In the **Preview** page, click **Publish**.</span></span>

    <span data-ttu-id="b95a3-491">![Publikování webové aplikace](build-restful-apis-with-aspnet-web-api/_static/image58.png "publikování webové aplikace")</span><span class="sxs-lookup"><span data-stu-id="b95a3-491">![Publishing the web application](build-restful-apis-with-aspnet-web-api/_static/image58.png "Publishing the web application")</span></span>

    <span data-ttu-id="b95a3-492">*Publikování webové aplikace*</span><span class="sxs-lookup"><span data-stu-id="b95a3-492">*Publishing the web application*</span></span>
9. <span data-ttu-id="b95a3-493">Až se proces publikování dokončí, otevře se váš výchozí prohlížeč publikovaného webu.</span><span class="sxs-lookup"><span data-stu-id="b95a3-493">Once the publishing process finishes, your default browser will open the published web site.</span></span>

    <span data-ttu-id="b95a3-494">![Publikování aplikace do Windows Azure](build-restful-apis-with-aspnet-web-api/_static/image59.png "publikování aplikace do Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="b95a3-494">![Application published to Windows Azure](build-restful-apis-with-aspnet-web-api/_static/image59.png "Application published to Windows Azure")</span></span>

    <span data-ttu-id="b95a3-495">*Aplikace publikovaná do Azure*</span><span class="sxs-lookup"><span data-stu-id="b95a3-495">*Application published to Azure*</span></span>
