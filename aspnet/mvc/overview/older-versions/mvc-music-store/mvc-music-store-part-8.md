...
Pokud chcete otestovat to zjistit, potřebujeme mít možnost přidávat položky na naše řešení nákupního košíku. Aktualizujeme naše **Store podrobnosti** aby zobrazení zahrnovalo na tlačítko "Přidat do košíku". Když jsme na to, můžeme zahrnout některé z alba Další informace, které jsme přidali protože jsme toto zobrazení poslední aktualizace: Rozšířením podle tematických interpreta, ceny a alb. Aktualizovaný kód Store podrobnosti zobrazení se zobrazí, jak je znázorněno níže.
