...
title: Nasazení databáze (C#) | Microsoft Docs
...
ms.locfileid: "74579913"
---
# <a name="deploying-a-database-c"></a>Nasazení databáze (C#)

[Scott Mitchell](https://twitter.com/ScottOnWriting)

[Stažení kódu](https://download.microsoft.com/download/E/6/F/E6FE3A1F-EE3A-4119-989A-33D1A9F6F6DD/ASPNET_Hosting_Tutorial_07_CS.zip) nebo [stažení PDF](https://download.microsoft.com/download/C/3/9/C391A649-B357-4A7B-BAA4-48C96871FEA6/aspnet_tutorial07_DeployDB_cs.pdf)
...
[![se databáze webových aplikací s recenzemi knih skládá ze čtyř tabulek](deploying-a-database-cs/_static/image2.jpg)](deploying-a-database-cs/_static/image1.jpg) 

**Obrázek 1**: databáze webových aplikací recenze knih se skládá ze čtyř tabulek ([kliknutím zobrazíte obrázek v plné velikosti).](deploying-a-database-cs/_static/image3.jpg)
...
[![stránky žánru technologie](deploying-a-database-cs/_static/image5.jpg)](deploying-a-database-cs/_static/image4.jpg) 

**Obrázek 2**: stránka Žánr technologie ([kliknutím zobrazíte obrázek v plné velikosti](deploying-a-database-cs/_static/image6.jpg))

[![recenze pro učení sami ASP.NET 3,5 za 24 hodin](deploying-a-database-cs/_static/image8.jpg)](deploying-a-database-cs/_static/image7.jpg) 

**Obrázek 3**: recenze pro *učení ASP.NET 3,5 za 24 hodin* ([kliknutím zobrazíte obrázek v plné velikosti](deploying-a-database-cs/_static/image9.jpg))
...
[![vyhledejte databázi v Průzkumníku databáze nebo Průzkumník serveru](deploying-a-database-cs/_static/image11.jpg)](deploying-a-database-cs/_static/image10.jpg) 

**Obrázek 4**: vyhledejte databázi v Průzkumníku databáze nebo Průzkumník serveru ([kliknutím zobrazíte obrázek v plné velikosti](deploying-a-database-cs/_static/image12.jpg)).
...
[![úvodní obrazovku průvodce publikováním databáze](deploying-a-database-cs/_static/image14.jpg)](deploying-a-database-cs/_static/image13.jpg) 

**Obrázek 5**: Úvodní obrazovka Průvodce publikováním databáze ([kliknutím zobrazíte obrázek v plné velikosti](deploying-a-database-cs/_static/image15.jpg))
...
> [!NOTE]
> Pokud se zobrazí chyba " *v databázi databáze pro typy* , které jsou v tomto průvodci, nejsou žádné žádné objekty". "při kliknutí na tlačítko Další na obrazovce zobrazené na obrázku 6 se ujistěte, že cesta k souboru databáze není delší dobu. Zjistili jsme, že k této chybě může dojít, pokud je cesta k souboru databáze moc dlouhá.

[![úvodní obrazovku průvodce publikováním databáze](deploying-a-database-cs/_static/image17.jpg)](deploying-a-database-cs/_static/image16.jpg) 

**Obrázek 6**: Úvodní obrazovka Průvodce publikováním databáze ([kliknutím zobrazíte obrázek v plné velikosti](deploying-a-database-cs/_static/image18.jpg))
...
[![skriptovat databázi do souboru nebo ji publikovat přímo pro poskytovatele webového hostitele](deploying-a-database-cs/_static/image20.jpg)](deploying-a-database-cs/_static/image19.jpg) 

**Obrázek 7**: Vytvoření skriptu databáze do souboru nebo jeho publikování přímo na poskytovatele webového hostitele ([kliknutím zobrazíte obrázek v plné velikosti](deploying-a-database-cs/_static/image21.jpg))
...
[![zadat možnosti publikování](deploying-a-database-cs/_static/image23.jpg)](deploying-a-database-cs/_static/image22.jpg) 

**Obrázek 8**: zadání možností publikování ([kliknutím zobrazíte obrázek v plné velikosti](deploying-a-database-cs/_static/image24.jpg))
...
[![se připojit k serveru databáze poskytovatele webového hostitele s](deploying-a-database-cs/_static/image26.jpg)](deploying-a-database-cs/_static/image25.jpg) 

**Obrázek 9**: připojení k databázovému serveru poskytovatele webového hostitele s ([kliknutím zobrazíte obrázek v plné velikosti](deploying-a-database-cs/_static/image27.jpg))
...
[![se připojit k serveru databáze poskytovatele webového hostitele s](deploying-a-database-cs/_static/image29.jpg)](deploying-a-database-cs/_static/image28.jpg) 

**Obrázek 10**: připojení k databázovému serveru poskytovatele webového hostitele s ([kliknutím zobrazíte obrázek v plné velikosti](deploying-a-database-cs/_static/image30.jpg))
...
[![databázových objektů byly duplikovány do provozní databáze.](deploying-a-database-cs/_static/image32.jpg)](deploying-a-database-cs/_static/image31.jpg) 

**Obrázek 11**: objekty databáze byly duplikovány do provozní databáze ([kliknutím zobrazíte obrázek v plné velikosti).](deploying-a-database-cs/_static/image33.jpg)

[![provozní databáze obsahuje stejná data jako na vývojové databázi.](deploying-a-database-cs/_static/image35.jpg)](deploying-a-database-cs/_static/image34.jpg) 

**Obrázek 12**: provozní databáze obsahuje stejná data jako na vývojové databázi ([kliknutím zobrazíte obrázek v plné velikosti).](deploying-a-database-cs/_static/image36.jpg)
