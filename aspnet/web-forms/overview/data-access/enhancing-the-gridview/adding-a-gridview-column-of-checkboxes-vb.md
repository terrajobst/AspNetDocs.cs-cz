...
[![EACH produktu řádek obsahuje zaškrtávací políčko](adding-a-gridview-column-of-checkboxes-vb/_static/image1.gif)](adding-a-gridview-column-of-checkboxes-vb/_static/image1.png)
...
[![CVytvořit nový účet ObjectDataSource s názvem ProductsDataSource](adding-a-gridview-column-of-checkboxes-vb/_static/image2.gif)](adding-a-gridview-column-of-checkboxes-vb/_static/image3.png)
...
[![Configurovat ObjectDataSource k načtení dat pomocí metody GetProducts()](adding-a-gridview-column-of-checkboxes-vb/_static/image3.gif)](adding-a-gridview-column-of-checkboxes-vb/_static/image5.png)
...
[![Set rozevírací seznamy v UPDATE, INSERT a DELETE karty na (žádný)](adding-a-gridview-column-of-checkboxes-vb/_static/image4.gif)](adding-a-gridview-column-of-checkboxes-vb/_static/image7.png)
...
[![Tmá název, kategorie a cena prvních deset produktů jsou uvedeny](adding-a-gridview-column-of-checkboxes-vb/_static/image5.gif)](adding-a-gridview-column-of-checkboxes-vb/_static/image9.png)
...
[![Add zaškrtávací políčko webové ovládací prvek s názvem ProductSelector k TemplateField s ItemTemplate](adding-a-gridview-column-of-checkboxes-vb/_static/image6.gif)](adding-a-gridview-column-of-checkboxes-vb/_static/image11.png)
...
[![EACH řádku produktu nyní obsahuje zaškrtávací políčko](adding-a-gridview-column-of-checkboxes-vb/_static/image7.gif)](adding-a-gridview-column-of-checkboxes-vb/_static/image13.png)
...
[![WPoto tlačítko vybrané produkty odstranit dojde ke kliknutí na ProductIDs vybrané produkty jsou uvedené](adding-a-gridview-column-of-checkboxes-vb/_static/image8.gif)](adding-a-gridview-column-of-checkboxes-vb/_static/image15.png)
...
[![CZkontrolujte všechny tlačítko vybere všechna zaškrtávací políčka licking](adding-a-gridview-column-of-checkboxes-vb/_static/image9.gif)](adding-a-gridview-column-of-checkboxes-vb/_static/image17.png)
