...
[![Ttři vlastností TemplateField se používají k přizpůsobení zobrazení](using-templatefields-in-the-gridview-control-cs/_static/image2.png)](using-templatefields-in-the-gridview-control-cs/_static/image1.png)
...
## <a name="step-1-binding-the-data-to-the-gridview"></a>Krok 1: Vazba dat k prvku GridView.
...
[![APřidat nový ovládací prvek ObjectDataSource, která volá metodu GetEmployees()](using-templatefields-in-the-gridview-control-cs/_static/image5.png)](using-templatefields-in-the-gridview-control-cs/_static/image4.png)

**Obrázek 2**: Přidat nový ovládací prvek ObjectDataSource tohoto volání `GetEmployees()` – metoda ([kliknutím ji zobrazíte obrázek v plné velikosti](using-templatefields-in-the-gridview-control-cs/_static/image6.png))
...
[![Tpro každý zaměstnanec zobrazené mu LastName, jméno, název a HireDate pole](using-templatefields-in-the-gridview-control-cs/_static/image8.png)](using-templatefields-in-the-gridview-control-cs/_static/image7.png)
...
[![Cpřevést na vlastnost BoundField do pole TemplateField z dialogového okna pole](using-templatefields-in-the-gridview-control-cs/_static/image11.png)](using-templatefields-in-the-gridview-control-cs/_static/image10.png)

**Obrázek 4**: Převést na vlastnost BoundField do pole TemplateField z dialogového okna pole ([kliknutím ji zobrazíte obrázek v plné velikosti](using-templatefields-in-the-gridview-control-cs/_static/image12.png))
...
[![The GridView šablony mohou být upravovat prostřednictvím the Designer](using-templatefields-in-the-gridview-control-cs/_static/image14.png)](using-templatefields-in-the-gridview-control-cs/_static/image13.png)
...
[![Add webové ovládacího prvku popisku k FirstName TemplateField ItemTemplate](using-templatefields-in-the-gridview-control-cs/_static/image17.png)](using-templatefields-in-the-gridview-control-cs/_static/image16.png)
...
[![CZvolte možnost Upravit datové vazby z inteligentních značek popisku](using-templatefields-in-the-gridview-control-cs/_static/image20.png)](using-templatefields-in-the-gridview-control-cs/_static/image19.png)
...
[![Bnajít vlastnost Text do pole LastName Data](using-templatefields-in-the-gridview-control-cs/_static/image23.png)](using-templatefields-in-the-gridview-control-cs/_static/image22.png)
...
[![Bokna FirstName a LastName hodnoty jsou uvedeny v jednom sloupci](using-templatefields-in-the-gridview-control-cs/_static/image26.png)](using-templatefields-in-the-gridview-control-cs/_static/image25.png)
...
[![Ev jednom sloupci se zobrazují jména a příjmení ACH zaměstnance](using-templatefields-in-the-gridview-control-cs/_static/image29.png)](using-templatefields-in-the-gridview-control-cs/_static/image28.png)
...
[![CPřevést HiredDate Vlastnost BoundField do TemplateField](using-templatefields-in-the-gridview-control-cs/_static/image32.png)](using-templatefields-in-the-gridview-control-cs/_static/image31.png)

**Obrázek 11**: Převést `HiredDate` Vlastnost BoundField do TemplateField ([kliknutím ji zobrazíte obrázek v plné velikosti](using-templatefields-in-the-gridview-control-cs/_static/image33.png))
...
[![Add ovládacího prvku kalendáře k HireDate TemplateField ItemTemplate](using-templatefields-in-the-gridview-control-cs/_static/image35.png)](using-templatefields-in-the-gridview-control-cs/_static/image34.png)
...
[![Bnajít vlastnost SelectedDate VisibleDate vlastnosti, které HiredDate datové pole](using-templatefields-in-the-gridview-control-cs/_static/image38.png)](using-templatefields-in-the-gridview-control-cs/_static/image37.png)
...
[![The zaměstnance HiredDate se zobrazí v ovládacím prvku Kalendář](using-templatefields-in-the-gridview-control-cs/_static/image41.png)](using-templatefields-in-the-gridview-control-cs/_static/image40.png)
...
## <a name="step-4-showing-the-number-of-days-the-employee-has-worked-for-the-company"></a>Krok 4: Zobrazuje počet dní, zaměstnanec pracoval pro společnost
...
[![Add nové TemplateField do prvku GridView.](using-templatefields-in-the-gridview-control-cs/_static/image44.png)](using-templatefields-in-the-gridview-control-cs/_static/image43.png)

**Obrázek 15**: Přidat nový TemplateField do prvku GridView ([kliknutím ji zobrazíte obrázek v plné velikosti](using-templatefields-in-the-gridview-control-cs/_static/image45.png))
...
[![TZobrazí se mu počet dnů zaměstnanec bylo v úloze](using-templatefields-in-the-gridview-control-cs/_static/image47.png)](using-templatefields-in-the-gridview-control-cs/_static/image46.png)

**Obrázek 16**: Počet dnů zaměstnance bylo v úloze se zobrazí ([kliknutím ji zobrazíte obrázek v plné velikosti](using-templatefields-in-the-gridview-control-cs/_static/image48.png))
