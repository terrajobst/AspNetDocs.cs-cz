...
Syntaxe Razor je jednoduché programovací syntaxi pro vkládání serverový kód na webové stránce. Na webové stránce, která používá syntaxi Razor, existují dva typy obsahu: obsah a server kód klienta. Obsah klienta je, co jste zvyklí na webových stránkách: Značka jazyka HTML (prvky), informace o stylu například šablony stylů CSS, možná klientský skript jako je JavaScript nebo jako prostý text.
