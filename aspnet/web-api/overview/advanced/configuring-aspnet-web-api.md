...
| Člen | Popis |
| --- | --- |
| **DependencyResolver** | Povolí vkládání závislostí pro řadiče. Zobrazit [použitím překladač závislostí webového rozhraní API](dependency-injection.md). |
| **Filtry** | Filtry akcí. |
...
<a id="services"></a>
## <a name="global-web-api-services"></a>Global Web API Services
