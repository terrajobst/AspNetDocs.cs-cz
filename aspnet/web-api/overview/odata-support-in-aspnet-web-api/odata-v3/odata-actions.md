...
V předchozím příkladu je akce vázán na jednu entitu: Klient hodnotí jednoho produktu. Akci můžete také navázat na kolekci entit. Stačí proveďte následující změny:
...
Tady je Proč to je důležité: Pokud akci je přechodná, musí server dali pokyn klientovi, pokud je daná akce dostupná. Dělá to tak, že včetně odkazu na akci v dané entitě. Tady je příklad entity filmu:
