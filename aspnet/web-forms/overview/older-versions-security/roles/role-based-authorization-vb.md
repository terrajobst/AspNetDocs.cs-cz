...
[![Tmá události kanálu ASP.NET pro k ověření uživatele při použití ověřování pomocí formulářů a rozhraní role](role-based-authorization-vb/_static/image2.png)](role-based-authorization-vb/_static/image1.png)
...
[![Tinformace o rolích uživatele he mohou být uloženy do souboru cookie ke zlepšení výkonu](role-based-authorization-vb/_static/image5.png)](role-based-authorization-vb/_static/image4.png)
...
[![Add soubor Web.config pro role adresáře](role-based-authorization-vb/_static/image8.png)](role-based-authorization-vb/_static/image7.png)
...
[![Ojen pro uživatele v roli správce můžete zobrazit na stránkách chráněné](role-based-authorization-vb/_static/image11.png)](role-based-authorization-vb/_static/image10.png)
...
[![Tšmídová, můžete navštívit UsersAndRoles.aspx stránky protože je v roli správce](role-based-authorization-vb/_static/image14.png)](role-based-authorization-vb/_static/image13.png)
...
[![The GridView pole může být nakonfigurované přes the dialogové okno pole](role-based-authorization-vb/_static/image17.png)](role-based-authorization-vb/_static/image16.png)
...
[![Tmá UserGrid GridView uvádí informace o každý uživatel v systému](role-based-authorization-vb/_static/image20.png)](role-based-authorization-vb/_static/image19.png)
...
[![MSpravovat LoginView pro konkrétní Role šablony prostřednictvím the Editor kolekce RoleGroup.](role-based-authorization-vb/_static/image23.png)](role-based-authorization-vb/_static/image22.png)
...
[![Tšmídová se zobrazí zprávy specifické pro roli správci](role-based-authorization-vb/_static/image29.png)](role-based-authorization-vb/_static/image28.png)
...
[![TOvládacího prvku LoginView he pracovního postupu pro určení, co šablona pro vykreslení](role-based-authorization-vb/_static/image32.png)](role-based-authorization-vb/_static/image31.png)
...
[![CPřevést CommandField do TemplateField](role-based-authorization-vb/_static/image35.png)](role-based-authorization-vb/_static/image34.png)
...
[![Tmá upravit a odstranit tlačítka jsou skryté jiných správců a správců bez](role-based-authorization-vb/_static/image38.png)](role-based-authorization-vb/_static/image37.png)
...
[![WAsistent při tlačítko Upravit je k dispozici pro vedoucí, skrytý tlačítko Odstranit](role-based-authorization-vb/_static/image41.png)](role-based-authorization-vb/_static/image40.png)
...
[![Tmá upravit a odstranit tlačítka jsou k dispozici pouze pro správce](role-based-authorization-vb/_static/image44.png)](role-based-authorization-vb/_static/image43.png)
...
[![If, které kontext zabezpečení nemá oprávnění k provádění metody, je vyvolána SecurityException –](role-based-authorization-vb/_static/image47.png)](role-based-authorization-vb/_static/image46.png)
