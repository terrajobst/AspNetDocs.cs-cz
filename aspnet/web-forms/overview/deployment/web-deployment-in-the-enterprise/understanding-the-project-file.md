...
Pokud chcete získat hodnotu vlastnosti, použijte formát *$(PropertyName)* . Například pro načtení hodnoty **ServerName** vlastnost, zadali byste:
