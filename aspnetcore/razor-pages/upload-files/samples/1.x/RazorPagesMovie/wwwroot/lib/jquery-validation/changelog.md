...
## <a name="core"></a>Jádro
  ...
  * Nemusíte hledat celého modelu DOM pro přepínač/zaškrtne políčko elementy
...
* Nepoužívejte form.elements jako that'sn nejde v jQuery 1.6 už nepodporuje. Jeho buggy jako a tím zlepšují přesto (IE6 – 8: form.elements === formuláře).
...
* Oprava volitelné metody zvýrazněte není nic vůbec Pokud je toto pole prázdné, které se nemají aktivovat úspěch
...
* Úplně odebrat závislost na ID prvku, ale stále slouží (Pokud je k dispozici) odkaz na vstupy chyba popisky. Můžete dosáhnout použitím pole s {name, zprávy, element} namísto objekt s id: zpráva páry pro interní errorList.
