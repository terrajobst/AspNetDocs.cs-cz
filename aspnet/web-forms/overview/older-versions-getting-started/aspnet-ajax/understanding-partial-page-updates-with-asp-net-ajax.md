...
| EnableScript-Globalization | Bool | Získá nebo nastaví, zda je povoleno skriptu globalization. |
| EnableScript-Localization | Bool | Získá nebo nastaví, jestli má skript lokalizace. |
...
| ProfileService | ProfileService-Manager | Načte podrobnosti o proxy služby profilace ASP.NET, které se pošlou do klienta. |
...
| UpdateMode | výčet (vždy, podmíněné) | Určuje, zda je během částečné vykreslení vždy aktualizovat prvku UpdatePanel nebo pokud je pouze aktualizován, když je spuštění aktivační události. |
...
| ContentTemplateContainer | Control | Získá programový šablonu pro žádost o aktualizaci. |
...
| **Značka** | **Popis** |
| --- | --- |
| &lt;ContentTemplate&gt; | Určuje kód, který se má použít k vykreslení částečného zobrazení výsledků. Podřízený &lt;asp: UpdatePanel&gt;. |
...
| **Značka** | **Popis** |
| --- | --- |
| &lt;ProgressTemplate&gt; | Obsahuje nastavení pro obsah, který se zobrazí s tímto ovládacím prvkem šablonu ovládacího prvku. |
