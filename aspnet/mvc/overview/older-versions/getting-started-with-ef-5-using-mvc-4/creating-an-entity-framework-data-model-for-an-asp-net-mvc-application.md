...
> 
> Existují tři způsoby, kterými můžete pracovat s daty v Entity Framework: *Databáze první*, *Model první*, a *Code First*. Tento kurz je určen pro Code First. Informace o rozdílech mezi těmito pracovními postupy a pokyny o tom, jak vybrat tu nejlepší pro váš scénář, naleznete v tématu [Entity Framework vývojářské pracovní postupy](https://msdn.microsoft.com/library/ms178359.aspx#dbfmfcf).
> 
> ## <a name="mvc"></a>MVC
> 
...
1. K vytvoření `Student` klikněte pravým tlačítkem na kontroler, **řadiče** složky v **Průzkumníku řešení**vyberte **přidat**a potom klikněte na **Kontroleru** . V **přidat kontroler** dialogového okna zadejte následující volby a pak klikněte na tlačítko **přidat**: 
   ...
   - Šablony: **Kontroler MVC s akcemi čtení/zápisu a zobrazeními, s využitím rozhraní Entity Framework**.
