...
> 
> Existují tři způsoby, kterými můžete pracovat s daty v Entity Framework: *Databáze první*, *Model první*, a *Code First*. Tento kurz je určen pro první databázi. Informace o rozdílech mezi těmito pracovními postupy a pokyny o tom, jak vybrat tu nejlepší pro váš scénář, naleznete v tématu [Entity Framework vývojářské pracovní postupy](https://msdn.microsoft.com/library/ms178359.aspx#dbfmfcf).
> 
...
Otevře se Průvodce datovým modelem Entity. V prvním kroku průvodce **Generovat z databáze** ve výchozím nastavení je vybraná možnost. Klikněte na **Další**.
