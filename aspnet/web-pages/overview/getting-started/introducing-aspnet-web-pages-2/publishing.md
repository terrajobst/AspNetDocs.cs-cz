...
Služba WebMatrix zobrazí soubory a databáze, které bude publikována do lokality. Protože při prvním publikování webu, jsou uvedeny všechny soubory. Zrušte zaškrtnutí políčka soubor, který není připravená k publikování. V následující publikace se zobrazí pouze soubory, které se změnily. Zobrazit [aktualizace živého webu: Opětovné](#update).
