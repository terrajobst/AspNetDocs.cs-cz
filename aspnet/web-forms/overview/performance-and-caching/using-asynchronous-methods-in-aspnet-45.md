...
V ukázkové aplikaci k dispozici, vyberete *GizmosCancelAsync* propojit volání *GizmosCancelAsync.aspx* stránce a ukazuje zrušení asynchronní volání (podle vypršení časového limitu). Doba zpoždění je náhodné rozsahu, potřebujete aktualizovat na stránce několikrát se zobrazí chybová zpráva vypršení časového limitu.
