...
- [Vytvoření nových uložených procedur prvků TableAdapter typových sad dat (C#)](creating-new-stored-procedures-for-the-typed-dataset-s-tableadapters-cs.md)
- [Použití stávajících uložených procedur komponentami TableAdapter typových sad dat (C#)](using-existing-stored-procedures-for-the-typed-dataset-s-tableadapters-cs.md)
...
- [Práce s vypočítanými sloupci (C#)](working-with-computed-columns-cs.md)
...
- [Vytvoření nových uložených procedur prvků TableAdapter typových sad dat (VB)](creating-new-stored-procedures-for-the-typed-dataset-s-tableadapters-vb.md)
- [Použití stávajících uložených procedur komponentami TableAdapter typových sad dat (VB)](using-existing-stored-procedures-for-the-typed-dataset-s-tableadapters-vb.md)
...
- [Práce s vypočítanými sloupci (VB)](working-with-computed-columns-vb.md)
