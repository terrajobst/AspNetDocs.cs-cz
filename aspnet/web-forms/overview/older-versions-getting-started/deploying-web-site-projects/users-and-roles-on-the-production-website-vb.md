...
[Stáhnout PDF](https://download.microsoft.com/download/5/C/5/5C57DB8C-5DEA-4B3A-92CA-4405544D313B/aspnet_tutorial16_CustomAWAT_vb.pdf)
...
ASP.NET 2,0 představil řadu *aplikačních služeb*, které jsou sadou stavebních blokových služeb, které můžete přidat do své webové aplikace. Do webu recenze webů jsme přidali služby pro členství a role zpátky v části [ *Konfigurace webu, který používá aplikační služby* kurzu](configuring-a-website-that-uses-application-services-vb.md). Služba členství usnadňuje vytváření a správu uživatelských účtů; Služba role nabízí rozhraní API pro kategorizaci uživatelů do skupin. Web recenze obsahuje tři uživatelské účty – Scott, Jisun a Alice – a jednu roli, správce s Scottem a Jisun v roli správce.
...
([Kliknutím zobrazíte obrázek v plné velikosti.](users-and-roles-on-the-production-website-vb/_static/image6.png))
...
([Kliknutím zobrazíte obrázek v plné velikosti.](users-and-roles-on-the-production-website-vb/_static/image9.png))
...
([Kliknutím zobrazíte obrázek v plné velikosti.](users-and-roles-on-the-production-website-vb/_static/image12.png))
...
V části [ *Konfigurace webu, který používá aplikační služby* kurzu](configuring-a-website-that-uses-application-services-vb.md) jsem přidal stránku do `Admin` složky s názvem `CreateAccount.aspx`. Tato stránka umožňuje správci přidat nový uživatelský účet k lokalitě a určit, zda byl nově vytvořený uživatel v roli správce (viz **Obrázek 5**).
...
([Kliknutím zobrazíte obrázek v plné velikosti.](users-and-roles-on-the-production-website-vb/_static/image15.png))
