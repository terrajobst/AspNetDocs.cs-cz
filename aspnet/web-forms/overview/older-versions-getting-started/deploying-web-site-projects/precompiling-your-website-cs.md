...
description: 'Visual Studio nabízí dva typy projektů vývojáře využívající technologii ASP.NET: Projekty webové aplikace (WAP) a webových projektů (WSPs). Jeden z klíčových rozdílů betwe...'
ms.author: riande
ms.date: 06/09/2009
...
**Obrázek 1**: Nástroj ASP.NET kompilace bude předkompilovat svůj web do zadané cílové umístění  
