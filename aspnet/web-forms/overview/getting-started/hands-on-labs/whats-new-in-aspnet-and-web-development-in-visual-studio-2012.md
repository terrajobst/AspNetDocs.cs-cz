...
Visual Studio obnovil editor jazyka JavaScript s velcí přístupné a uspořádané režimu kódu. Mnoho funkcí sady Visual Studio, které existovaly už v C# nebo VB editory je nyní implementována v JavaScript editoru: Přejít k definici, Automatické odsazení, dokumentaci a ověření v případě, že píšete. Pomocí seznamu obnovené IntelliSense máte katalogu funkce jazyka JavaScript na dosah ruky.
...
### <a name="exercise-4-bundling-and-minification"></a>Cvičení 4: Vytváření sady a minifikace
