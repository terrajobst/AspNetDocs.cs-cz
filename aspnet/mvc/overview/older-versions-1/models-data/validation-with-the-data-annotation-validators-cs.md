...
**Obrázek 1**: Přidání odkazu na pořadač modelů datových poznámek ([kliknutím zobrazíte obrázek v plné velikosti](validation-with-the-data-annotation-validators-cs/_static/image3.png))
...
Tento řádek kódu registruje ataAnnotationsModelBinder jako výchozí modelový pořadač pro celou aplikaci ASP.NET MVC.
...
**Obrázek 6**: použití validátorů s entity frameworkem ([kliknutím zobrazíte obrázek v plné velikosti](validation-with-the-data-annotation-validators-cs/_static/image14.png))
