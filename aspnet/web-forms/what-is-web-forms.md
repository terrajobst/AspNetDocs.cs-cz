...
- **Zabezpečení**-důležitou součástí vývoje aplikace bezpečnější je pochopit na ohrožení. Microsoft vyvinul způsob, jak zařadit hrozby: Falšování identity, manipulace, Odvolatelnost, zpřístupnění informací, odepření služby, zvýšení úrovně oprávnění (krok). Ve webových formulářů ASP.NET můžete přidat bodů rozšiřitelnosti a možnosti konfigurace, které vám umožní přizpůsobit různé chování zabezpečení ve webových formulářů ASP.NET.
