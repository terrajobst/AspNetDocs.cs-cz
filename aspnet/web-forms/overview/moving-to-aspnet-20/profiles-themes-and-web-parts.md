...
| EditorZone | Obsahuje ovládací prvky EditorPart. Povolit uživatelům upravit a přizpůsobit ovládací prvky webové části na stránce pomocí této zóny. |
...
## <a name="lab-create-a-web-part-page"></a>Lab: Vytvořit stránku webových částí
