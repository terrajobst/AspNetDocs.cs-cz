...
1. [Cvičení 1: Vkládání Kontroleru](#Exercise1)
2. [Cvičení 2: Vkládání zobrazení](#Exercise2)
3. [Cvičení 3: Vkládání filtry](#Exercise3)
...
### <a name="exercise-1-injecting-a-controller"></a>Cvičení 1: Vkládání Kontroleru
...
3. Zahrnout následující obory názvů: **MvcMusicStore.Services** a **MusicStore.Controllers**.
...
### <a name="exercise-2-injecting-a-view"></a>Cvičení 2: Vkládání zobrazení
...
5. ASP.NET MVC 4 výchozího překladače závislostí provede nahraďte instance **UnityDependencyResolver**. Chcete-li to provést, nahraďte **inicializovat** metoda obsah následujícím kódem:
...
### <a name="exercise-3-injecting-action-filters"></a>Cvičení 3: Vkládání filtrů Akce
