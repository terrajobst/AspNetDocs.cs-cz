...
## <a name="step-1-validating-credentials-against-the-membership-user-store"></a>Krok 1: Ověřují se přihlašovací údaje proti Store členství uživatele
...
[![The přihlašovací stránky rozhraní zahrnuje dvě textová pole, třídy CheckBoxList a tlačítko](validating-user-credentials-against-the-membership-user-store-vb/_static/image2.png)](validating-user-credentials-against-the-membership-user-store-vb/_static/image1.png)

**Obrázek 1**: Přihlašovací stránky rozhraní zahrnuje dvě textová pole, třídy CheckBoxList a tlačítko ([kliknutím ji zobrazíte obrázek v plné velikosti](validating-user-credentials-against-the-membership-user-store-vb/_static/image3.png))
...
[![Ckomentáře navýšení kapacity existující deklarativní a zdrojový kód v Login.aspx](validating-user-credentials-against-the-membership-user-store-vb/_static/image5.png)](validating-user-credentials-against-the-membership-user-store-vb/_static/image4.png)
...
[![Add přihlašovací ovládací prvek na stránce](validating-user-credentials-against-the-membership-user-store-vb/_static/image8.png)](validating-user-credentials-against-the-membership-user-store-vb/_static/image7.png)

**Obrázek 3**: Přidejte ovládací prvek Login stránku ([kliknutím ji zobrazíte obrázek v plné velikosti](validating-user-credentials-against-the-membership-user-store-vb/_static/image9.png))
...
[![Add přihlašovací ovládací prvek na stránce](validating-user-credentials-against-the-membership-user-store-vb/_static/image11.png)](validating-user-credentials-against-the-membership-user-store-vb/_static/image10.png)

**Obrázek 4**: Přidejte ovládací prvek Login stránku ([kliknutím ji zobrazíte obrázek v plné velikosti](validating-user-credentials-against-the-membership-user-store-vb/_static/image12.png))
...
[![The přihlášení ovládacího prvku vlastnosti hodnoty určují jeho vzhled](validating-user-credentials-against-the-membership-user-store-vb/_static/image14.png)](validating-user-credentials-against-the-membership-user-store-vb/_static/image13.png)
...
[![CPřevést ovládacího prvku pro přihlášení do šablony](validating-user-credentials-against-the-membership-user-store-vb/_static/image17.png)](validating-user-credentials-against-the-membership-user-store-vb/_static/image16.png)
...
[![Fk dispozici při přihlášení řídicí je převést na šablonu jsou nastaveny vlastnosti ewer](validating-user-credentials-against-the-membership-user-store-vb/_static/image20.png)](validating-user-credentials-against-the-membership-user-store-vb/_static/image19.png)
...
[![Tmá ovládací prvek Login teď obsahuje textové pole pro e-mailovou adresu uživatele](validating-user-credentials-against-the-membership-user-store-vb/_static/image23.png)](validating-user-credentials-against-the-membership-user-store-vb/_static/image22.png)
...
[![TOvěřovací pracovní postup používaný přihlášení ovládacího prvku](validating-user-credentials-against-the-membership-user-store-vb/_static/image26.png)](validating-user-credentials-against-the-membership-user-store-vb/_static/image25.png)
...
[![Tšmídová nelze přihlášení při zadání nesprávné e-mailovou adresu](validating-user-credentials-against-the-membership-user-store-vb/_static/image29.png)](validating-user-credentials-against-the-membership-user-store-vb/_static/image28.png)
...
[![Tšmídová provádí příliš mnoho neplatný pokusů o přihlášení a má byl uzamčen Out](validating-user-credentials-against-the-membership-user-store-vb/_static/image32.png)](validating-user-credentials-against-the-membership-user-store-vb/_static/image31.png)
...
- [Postupy: Vytvořit přihlašovací stránky technologie ASP.NET](https://msdn.microsoft.com/library/ms178331.aspx)
