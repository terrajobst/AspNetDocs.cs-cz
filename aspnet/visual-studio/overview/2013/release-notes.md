...
Zabezpečení prohlížečů brání webovým stránkám v odesílání požadavků AJAX na jinou doménu. [CORS](http://www.w3.org/TR/cors/) je standard W3C, která umožňuje server zmírnit zásadu stejného zdroje. Pomocí CORS, server explicitně můžou některé požadavky cross-origin zatímco jiné odmítnout.
...
**Přidání do projektu Microsoft.Owin.Cors**: Pokud chcete nainstalovat tuto knihovnu, spusťte následující příkaz v konzole Správce balíčků:
...
2. **Request.Url nebo RequestContext.Url má hodnotu null během žádosti o služby batch**
    ...
    Tento problém je aktuálně sledovat tady: [Má hodnotu null pro dávkové zpracování požadavku BatchRequestContext.Url](http://aspnetwebstack.codeplex.com/workitem/1301).
