...
---
# <a name="aspnet-mvc-storefront-part-1-architectural-discussion-and-overview"></a>Prezentace ASP.NET MVC – část 1: Architektura a celkový přehled

podle [Rob Conery](https://github.com/robconery)

Rob Conery zahrnuje počáteční architektuře zde, v části 1, ve kterém probírá použitému vzoru s Ayende Rahien a Steve Harman. Také žádá Phil Haack co je první: Test kuřecí nebo Egg modelu.
