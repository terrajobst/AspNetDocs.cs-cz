...
title: jQuery. Validate – verze 1.8.1 | Microsoft Docs
...
ms.locfileid: "78585055"
---
# <a name="jqueryvalidate-version-181"></a><span data-ttu-id="d0361-102">jquery.validate verze 1.8.1</span><span class="sxs-lookup"><span data-stu-id="d0361-102">jquery.validate version 1.8.1</span></span>

<span data-ttu-id="d0361-103">Následující soubory jsou hostovány v CDN:</span><span class="sxs-lookup"><span data-stu-id="d0361-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="d0361-104">Soubory lokalizace na https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js, kde # # je kód Loc.</span><span class="sxs-lookup"><span data-stu-id="d0361-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
