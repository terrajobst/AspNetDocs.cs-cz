...
ms.locfileid: "57067816"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="96f78-102">jQuery Templates Beta 1</span><span class="sxs-lookup"><span data-stu-id="96f78-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="96f78-103">Modul plug-in Šablony jQuery zahrnuje následující soubory:</span><span class="sxs-lookup"><span data-stu-id="96f78-103">The jQuery Templates plugin includes the following files:</span></span>
