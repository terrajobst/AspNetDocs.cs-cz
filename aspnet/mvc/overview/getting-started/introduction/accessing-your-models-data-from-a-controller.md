...
Klikněte na **Přidat**. (Pokud dojde k chybě, pravděpodobně nebyla sestavení aplikace před zahájením přidat kontroler.) Visual Studio vytvoří následující soubory a složky:
