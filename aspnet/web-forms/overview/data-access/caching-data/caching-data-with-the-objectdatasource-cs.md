...
## <a name="step-1-creating-the-caching-web-pages"></a>Krok 1: Vytváří se ukládání do mezipaměti webové stránky
...
[![Figure 2: Přidat SectionLevelTutorialListing.ascx uživatelský ovládací prvek na Default.aspx](caching-data-with-the-objectdatasource-cs/_static/image3.png)](caching-data-with-the-objectdatasource-cs/_static/image2.png)
...
[![Configurovat ObjectDataSource pomocí třídy ProductsBLL](caching-data-with-the-objectdatasource-cs/_static/image7.png)](caching-data-with-the-objectdatasource-cs/_static/image6.png)
...
[![Set aktualizace kartu s rozevíracím seznamu příslušné UpdateProduct přetížení](caching-data-with-the-objectdatasource-cs/_static/image10.png)](caching-data-with-the-objectdatasource-cs/_static/image9.png)
...
[![EPovolit podporu GridView pro úpravy, řazení a stránkování](caching-data-with-the-objectdatasource-cs/_static/image13.png)](caching-data-with-the-objectdatasource-cs/_static/image12.png)
...
[![EACH produkt s názvem, kategorie a cena je uveden v Sortable, Pageable, upravitelné GridView](caching-data-with-the-objectdatasource-cs/_static/image16.png)](caching-data-with-the-objectdatasource-cs/_static/image15.png)
...
[![ATlačítko na stránce nad prvku GridView a dd popisek](caching-data-with-the-objectdatasource-cs/_static/image19.png)](caching-data-with-the-objectdatasource-cs/_static/image18.png)
...
[![WZobrazí se henever, které prvku GridView je znovu připojeno ke zdroji dat, výběr události vyvolané](caching-data-with-the-objectdatasource-cs/_static/image22.png)](caching-data-with-the-objectdatasource-cs/_static/image21.png)
...
[![Clicking způsobí zpětné odeslání tlačítka prvku GridView. Chcete-li být znovu vytvořena z svůj stav zobrazení](caching-data-with-the-objectdatasource-cs/_static/image25.png)](caching-data-with-the-objectdatasource-cs/_static/image24.png)
...
## <a name="step-4-caching-the-data-using-the-objectdatasource"></a>Krok 4: Ukládání do mezipaměti Data s využitím ObjectDataSource
...
[![Configurovat ObjectDataSource pro ukládání do mezipaměti svá Data po dobu 30 sekund](caching-data-with-the-objectdatasource-cs/_static/image28.png)](caching-data-with-the-objectdatasource-cs/_static/image27.png)
