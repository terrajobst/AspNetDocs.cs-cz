...
title: ASP.NET webové formuláře a AJAX 4.5.2 | Microsoft Docs
...
ms.locfileid: "78563341"
---
# <a name="aspnet-web-forms-and-ajax-452"></a><span data-ttu-id="fea17-102">Webové formuláře ASP.NET a Ajax 4.5.2</span><span class="sxs-lookup"><span data-stu-id="fea17-102">ASP.NET Web Forms and Ajax 4.5.2</span></span>

<span data-ttu-id="fea17-103">Následující soubory jsou hostovány v CDN:</span><span class="sxs-lookup"><span data-stu-id="fea17-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="fea17-104">Poznámka: skripty globalizace, jako je fr-FR. js, najdete v následující složce:</span><span class="sxs-lookup"><span data-stu-id="fea17-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
