...
Příkaz Eval("CategoryName") dává pokyn, že pro aktuální položku v vázané kolekce položek dat, načíst změnu hodnoty názvy položek Entity Model "CategoryName". Toto je stručné syntaxe pro velmi výkonné funkce.
