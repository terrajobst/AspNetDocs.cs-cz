...
Oblasti umožňují organizovat velkého projektu do několika menších oddílů, aby bylo možné zvládnout složité velké webové aplikace. Každý oddíl ("oblasti") obvykle představuje samostatný oddíl velký webové stránky a slouží k seskupení souvisejících sad kontrolerů a zobrazení. Další informace najdete v tématu [názorný postup: Uspořádání aplikaci ASP.NET MVC v oblastech](https://go.microsoft.com/fwlink/?LinkId=158978) na webové stránce MSDN.
